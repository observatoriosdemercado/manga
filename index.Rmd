...
data <- as.Date("2022-10-14") #ajustar semanalmente
sem_ano <- 41 #ajustar semanalmente
...
### Área Plantada com Manga no Brasil em 2021 
``` {r}
num <- 76.9 
valueBox(
...
### Produtividade média da Manga no Brasil em 2021 
``` {r}
num <- 19.8
valueBox(
...
### Volume com Manga produzida no Brasil em 2021 
``` {r}
num <- 1.51
valueBox(
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Área com Manga no Brasil: 2015-2021',
...
g3 <- dados %>% 
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade com Manga no Brasil: 2015-2021',
       caption = "IBGE (2022)") +
...
g4 <- dados %>% 
  ...
  labs(y= "VBP (Mil R$)", x= "Anos", title='Evolução do Valor Bruto da Produção com Manga no Brasil: 2015-2021',
       caption = "IBGE (2022)") +
...
### Área Plantada com Manga no Vale S. Francisco em 2021 
``` {r}
num <- 34.4 
valueBox(
  value = paste0(num, " Mil Hectares"),
...
### Produtividade média da Manga no Vale S. Francisco em 2021 
``` {r}
num <- 27
valueBox(
  value = paste0( num, " Toneladas/Hectare"),
...
### Volume com Manga produzida no Vale S. Francisco em 2021 
``` {r}
num <- 924.5
valueBox(
...
g1 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor1)+
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Manga no Vale do São Francisco: 2015-2021',
       caption = "Fonte: IBGE (2022)") +
  scale_y_continuous(limits=c(0, 35000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2015, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g4 <- dados %>% 
  ...
  geom_col(aes(x=ano, y=vbp/1000, fill="Valor Bruto Produção (Mil R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "VBP (Mil R$)", x= "Anos", title='Evolução do Valor Bruto da Produção com Manga no Vale do São Francisco: 2015-2021',
       caption = "IBGE (2022)") +
...
#Entrando dados no R
dados1 <- read.csv2('agosto_2022.csv', header=T, sep=";", dec = ".")
...
load("agosto_22_caged.RData")

#dados_01_vsf$sexo <- lapply(dados_01_vsf$sexo, factor)

dados_08_vsf$sexo[dados_08_vsf$sexo == 1] <- 0
dados_08_vsf$sexo[dados_08_vsf$sexo == 3] <- 1

dados_08_vsf <- mutate(dados_08_vsf,
                sexo = factor(sexo, levels = 0:1, labels = c("Masculino", "Feminino")))

# Mantendo apenas 

#Separando as admissoes e as demissoes
dados_08_vsf_positivos <-dados_08_vsf%>% filter(saldo_movim=="1")
dados_08_vsf_negativos <-dados_08_vsf%>% filter(saldo_movim=="-1")

#Mantendo apenas o agronegocio
secao_positivos <-dados_08_vsf_positivos%>% filter(secao=="A")
secao_negativos <-dados_08_vsf_negativos%>% filter(secao=="A")

#Mantendo apenas a manga
subclasse_positivos <-dados_08_vsf_positivos%>% filter(subclasse=="133410")
subclasse_negativos <-dados_08_vsf_negativos%>% filter(subclasse=="133410")
...
FORMAÇÃO {data-navmenu="CUSTO DE PRODUÇÃO"}
======================================================================
...
#Entrando dados no R
dados <- read_excel("custo2021.xlsx", col_names = TRUE)
...
### Crescimento Custo de de Oper. Mecanizadas
``` {r}
num <- 93.83 
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " %"),
#  color = "lightblue3",
  icon= "fa-arrow-up")
```

### Crescimento Custo de Oper. Manuais
``` {r}
num <- 25.87
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " %"),
...
### Operaçoes Mecanizadas{.no-title}

```{r agrianual1}
g1 <- dados %>% 
  filter(abrangencia=='formacao') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Op_Mecanizadas, fill="Custo (R$) com Operações Mecanizadas"), lwd=1)+
  scale_fill_manual(values=mycolor1)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Mecanizadas: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 18000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
...
### Operaçoes Manuais{.no-title}

```{r agrianual2}
g2 <- dados %>% 
  filter(abrangencia=='formacao') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Op_Manuais, fill="Custo (R$) com Operações Manuais"), lwd=1)+
  scale_fill_manual(values=mycolor2)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Manuais: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 6000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g3 <- dados %>% 
  filter(abrangencia=='formacao') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Insumos, fill="Custo (R$) com Insumos"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Insumos: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 8000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Custo Total Formaçao {.no-title}

```{r agrianual4}
g4 <- dados %>% 
  filter(abrangencia=='formacao') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Custo_Total, fill="Custo Total de formação (R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com formação: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 50000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
PRODUÇÃO ESTÁVEL {data-navmenu="CUSTO DE PRODUÇÃO"}
======================================================================
...
g1 <- dados %>% 
  ...
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
        axis.title.x = element_text(size=10, face = "bold", margin = margin(b=0)),
        axis.title.y = element_text(size=10, face = "bold", margin = margin(l=20)),
        plot.title = element_text(hjust = 0.5, size=12),
        plot.caption = element_text(hjust = 0, size=8),
        legend.position = "bottom", legend.title = element_blank(),
...
g2 <- dados %>% 
  ...
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Manuais: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 3000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
...
g2 <- dados %>% 
  ...
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Insumos, fill="Custo (R$) com Insumos"), lwd=1)+
  scale_fill_manual(values=mycolor5)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Insumos: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
...
### Administrativos {.no-title}

```{r agrianual4a}
g3 <- dados %>% 
  filter(abrangencia=='estavel') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Administracao, fill="Custos (R$) com Administrativo"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Administrativo: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 6000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
...
### Custo Total Quilo {.no-title}

```{r agrianual5a}
g4 <- dados %>% 
  filter(abrangencia=='estavel') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Custo_Total, fill="Custo Total por Quilo (R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) por Quilo: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
...
### Beneficio/Custo {.no-title}

```{r agrianual6a}
g4 <- dados %>% 
  filter(abrangencia=='estavel') %>% 
  ggplot() +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=Beneficio_Custo, fill="Relação Benefício/Custo"), lwd=1)+
  scale_fill_manual(values=mycolor6)+
  labs(y= "Beneficio/Custo", x= "Anos", title='Evolução da Relação Benefício/Custo: 2016-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 3), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2016, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
