...
#Entrando dados no R
dados1 <- read.csv2('outubro_2025.csv', header=T, sep=";", dec = ".")
...
subclasse_positivos <-dados_10_vsf_positivos%>% filter(subclasse=="133410")
subclasse_negativos <-dados_10_vsf_negativos%>% filter(subclasse=="133410")
