...
library(lubridate)
data <- as.Date("2023-02-10") #ajustar semanalmente
sem_ano <- 6 #ajustar semanalmente
...
#Entrando dados no R
dados1 <- read.csv2('dezembro_2022.csv', header=T, sep=";", dec = ".")
