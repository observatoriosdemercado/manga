...
#Entrando dados no R
dados1 <- read.csv2('agosto_2025.csv', header=T, sep=";", dec = ".")
...
g4 <- ggplot(data = subclasse_positivos, aes(x = grau_instrucao, y = ..count..)) +
  geom_bar(fill='#1e4971')+
    scale_y_continuous(limits=c(0, 650), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
...
g1 <- ggplot()+
  ...
  labs(y= "Preço Palmer (R$)", x= "Semanas de cada Ano", title='Mínimo, Máximo, Média e preços de 2023 a 2025 de Manga Palmer ao produtor',
