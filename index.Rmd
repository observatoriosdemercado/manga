...
#Entrando dados no R
dados <- read_excel("manga_ibge2023.xlsx", col_names = TRUE)
...
### Área Plantada com Manga no Brasil em 2023 
``` {r}
num <- 80.7 
valueBox(
...
### Produtividade média da Manga no Brasil em 2023 
``` {r}
num <- 22
valueBox(
...
### Volume com Manga produzida no Brasil em 2023 
``` {r}
num <- 1.76
valueBox(
...
### Valor Produção com Manga produzida no Brasil em 2023 
``` {r}
num <- 3.23
valueBox(
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Área com Manga no Brasil: 2014-2023',
...
g2 <- dados %>% 
  ...
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume com Manga no Brasil: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 1800), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g3 <- dados %>% 
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade com Manga no Brasil: 2014-2023',
       caption = "IBGE (2024)") +
...
labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção com Manga no Brasil: 2014-2023',
       caption = "IBGE (2024)") +
  scale_y_continuous(limits=c(0, 3300), n.breaks = 8, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Área Plantada com Manga no Vale S. Francisco em 2023 
``` {r}
num <- 37.9 
valueBox(
  value = paste0(num, " Mil Hectares"),
...
### Produtividade média da Manga no Vale S. Francisco em 2023 
``` {r}
num <- 31
valueBox(
  value = paste0( num, " Toneladas/Hectare"),
...
### Volume com Manga produzida no Vale S. Francisco em 2023 
``` {r}
num <- 1.16
valueBox(
...
g1 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor1)+
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Manga no Vale do São Francisco: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
...
g2 <- dados %>% 
  ...
  geom_col(aes(x=ano, y=quantidade/1000, fill="Volume (Mil Toneladas)"), lwd=1)+
  scale_fill_manual(values=mycolor2)+
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume com Manga no Vale do São Francisco: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 1200), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g3 <- dados %>% 
  ...
  geom_col(aes(x=ano, y=produtividade, fill="Produtividade (Toneladas/Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade com Manga no Vale do São Francisco: 2014-2023',
       caption = "IBGE (2024)") +
...
g4 <- dados %>% 
  ...
  geom_col(aes(x=ano, y=vbp/1000, fill="Valor Bruto Produção (Milhões R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção com Manga no Vale do São Francisco: 2014-2023',
       caption = "IBGE (2024)") +
  scale_y_continuous(limits=c(0, 2300), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
#Entrando dados no R
dados1 <- read.csv2('abril_2025.csv', header=T, sep=";", dec = ".")
...
g4 <- ggplot(data = subclasse_positivos, aes(x = grau_instrucao, y = ..count..)) +
  geom_bar(fill='#1e4971')+
    scale_y_continuous(limits=c(0, 400), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
