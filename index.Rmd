...
#Entrando dados no R
dados1 <- read.csv2('janeiro_2023.csv', header=T, sep=";", dec = ".")
...
g4 <- ggplot(data = subclasse_positivos, aes(x = grau_instrucao, y = ..count..)) +
  geom_bar(fill='#1e4971')+
    scale_y_continuous(limits=c(0, 170), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
