...
library(lubridate)
data <- as.Date("2023-10-06") #ajustar semanalmente
sem_ano <- 40 #ajustar semanalmente
...
#Entrando dados no R
dados1 <- read.csv2('agosto_2023.csv', header=T, sep=";", dec = ".")
...
data <- as.Date("2023-10-13") #ajustar semanalmente
