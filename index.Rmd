...
g1 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor1)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Mecanizadas: 2012-2021',
...
g2 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor2)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Manuais: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 9000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2012, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g3 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor3)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Insumos: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 14000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2012, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
g4 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor4)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com formação: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
...
g2 <- dados %>% 
  ...
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Operações Manuais: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 4000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2012, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
...
g3 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor3)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) com Administrativo: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
...
g4 <- dados %>% 
  ...
  scale_fill_manual(values=mycolor4)+
  labs(y= "R$", x= "Anos", title='Evolução do Custo (R$) por Quilo: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
  scale_y_continuous(limits=c(0, 28000), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2012, 2021, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=10, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=10, margin = margin(l=20)),
...
g4 <- dados %>% 
  ...
  labs(y= "Beneficio/Custo", x= "Anos", title='Evolução da Relação Benefício/Custo: 2012-2021',
       caption = "Fonte: Agrianual (2017:2022)") +
