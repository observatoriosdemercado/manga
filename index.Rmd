...
library(lubridate)
data <- as.Date("2024-01-26") #ajustar semanalmente
sem_ano <- 04 #ajustar semanalmente
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias21,2), matrix[,2], round(tail(preco_palmer_2022,52),2),
...
table_db <- data.frame(matrix[,1], round(medias21,2), matrix[,2], round(tail(preco_palmer_2022,52),2),
                    round(tail(preco_palmer_2023,52),2), preco_palmer_2024[,1])
...
g1 <- ggplot()+
  ...
  labs(y= "Preço R$", x= "Semanas de cada Ano", title='Mínimo, Máximo, Média e preços de 2021 a 2024 de Manga Palmer ao produtor',
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias21,2), matrix[,2], round(tail(preco_tommy_2022,52),2),
...
table_db <- data.frame(time, matrix[,1], round(medias21,2), matrix[,2], round(tail(preco_tommy_2022,52),2),
                    round(tail(preco_tommy_2023,52),2), preco_tommy_2024[,1])
