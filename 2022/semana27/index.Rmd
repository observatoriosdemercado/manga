...
library(lubridate)
last <- as.Date("2022-07-01")
today <- as.Date("2022-07-08")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,29, variando entre R\$3,00 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,32. Em 2020, o preço deflacionado é de R\$3,72 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,35. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 0,88\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,81, variando entre R\$3,20 e R\$2,10. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,70, maior que o preço deflacionado de 2020 (R\$2,78) e maior que o preço de 2021 (R\$1,39). Em relação à semana anterior os preços tiveram um forte aumento de 0,72%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,64 variando entre R\$3,00 e R\$2,20. Isto representa uma queda de 0,75\% em relação à semana anterior. No caso da Tommy para a Europa o preço médio foi de R\$3,20, variando entre o mínimo de R\$3,50 e o máximo de R\$3,00, um crescimento de 6,67\% em relação à semana anterior. 
