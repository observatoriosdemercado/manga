...
library(lubridate)
last <- as.Date("2022-08-19")
today <- as.Date("2022-08-26")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,44, variando entre R\$1,60 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,39. Em 2020, o preço deflacionado é de R\$2,35 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,67. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -17,24\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,11, variando entre R\$1,33 e R\$1,00. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,71, menor que o preço deflacionado de 2020 (R\$2,28) e que o preço de 2021 (R\$1,50). Em relação à semana anterior os preços tiveram uma queda expressiva de -31,48%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$1,74 variando entre R\$1,80 e R\$1,60. Isto representa uma queda de -8,42\% em relação à semana anterior. 
