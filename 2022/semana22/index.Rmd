...
library(lubridate)
last <- as.Date("2022-05-27")
today <- as.Date("2022-06-03")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,95, variando entre R\$2,20 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,39. Em 2020, o preço deflacionado é de R\$4,87 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,80. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um diminuição de -14,85\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,81, variando entre R\$2,00 e R\$1,60. Este valor é mais baixo do que a média histórica para esta semana, R\$ 3,05, menor que o preço deflacionado de 2020 (R\$4,50), mas é maior que o preço de 2021 (R\$1,28). Em relação à semana anterior os preços tiveram uma queda de -13,40%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,20, variando entre R\$2,40 e R\$2,00. 
