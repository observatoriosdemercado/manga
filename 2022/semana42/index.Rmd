...
library(lubridate)
last <- as.Date("2022-10-14")
today <- as.Date("2022-10-21")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,25, variando entre R\$1,40 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,77. Em 2020, o preço deflacionado é de R\$1,48 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,04. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram aumentaram 0,81%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,12, variando entre R\$1,30 e R\$1,00. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,35, mas é maior que o preço deflacionado de 2020 (R\$1,04) e é maior que o preço de 2021 (R\$0,46). Em relação à semana anterior os preços tiveram uma redução de -0,88%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,61 variando entre R\$1,80 e R\$1,40, queda de 1% em relaçao à semana anterior. A manga Tommy para os Estados Unidos foi cotada na médias de R\$1,47, variando entre R\$ 1,50 e R\$1,40, redução de -11%. A Kent foi cotada a R\$2,18 na média, variando entre R\$2,40 e R\$2,20, queda de -1%. 
