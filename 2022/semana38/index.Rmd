...
library(lubridate)
last <- as.Date("2022-09-16")
today <- as.Date("2022-09-23")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,13, variando entre R\$1,30 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,01. Em 2020, o preço deflacionado é de R\$1,77 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,09. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma diminuição de -14,39\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,30, variando entre R\$1,40 e R\$1,10. Este valor é mais baixo do que a média histórica para esta semana, R\$ 21,65, menor que o preço deflacionado de 2020 (R\$1,44), mas é maior que o preço de 2021 (R\$1,07). Em relação à semana anterior os preços tiveram uma diminuição de -15,03%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,50 variando entre R\$1,60 e R\$1,40. Em relação a semana anterior, uma queda de -13,3%. A manga Tommy para os Estados Unidos e para a Europa tiveram cotações médias diferentes, R\$1,75 e R\$1,70, respectivamente. Contudo, em ambos os casos os valores variaram entre R\$ 1,80 e R\$1,60. Na comparação com a semana anterior, a Tommy para os Estados Unidos teve queda de -11,62% nos preços e a Tommy para a Europa de -14,14%.
