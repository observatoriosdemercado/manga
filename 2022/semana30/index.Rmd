...
library(lubridate)
last <- as.Date("2022-07-22")
today <- as.Date("2022-07-29")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,23, variando entre R\$2,60 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,37. Em 2020, o preço deflacionado é de R\$3,54 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,88. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 5,19\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,09, variando entre R\$2,30 e R\$2,00. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,16, menor que o preço deflacionado de 2020 (R\$3,45) e maior que o preço de 2021 (R\$0,96). Em relação à semana anterior os preços tiveram uma forte queda de -18,99%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,66 variando entre R\$2,80 e R\$2,40. Isto representa um crescimento de 3,10\% em relação à semana anterior. 
