...
library(lubridate)
last <- as.Date("2022-12-09")
today <- as.Date("2022-12-16")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,70, variando entre R\$0,90 e R\$0,60. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,13. Em 2020, o preço deflacionado é de R\$0,78 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 2,24. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -4,11%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,79, variando entre R\$1,00 e R\$0,60. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,07, menor que o preço deflacionado de 2020 (R\$1,02) e que o preço de 2021 (R\$1,30). Em relação à semana anterior os preços aumentaram 102,56%.

Em relação aos preços de exportação, o único disponível foi de Palmer, na média de R\$1,13, variando entre R\$1,30 e R\$1,00.
