...
library(lubridate)
last <- as.Date("2022-09-23")
today <- as.Date("2022-09-30")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,11, variando entre R\$1,20 e R\$0,90. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,98. Em 2020, o preço deflacionado é de R\$1,79 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,20. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma diminuição de -1,77\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,10, variando entre R\$1,20 e R\$0,90. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,31, menor que o preço deflacionado de 2020 (R\$1,13), mas é maior que o preço de 2021 (R\$0,79). Em relação à semana anterior os preços tiveram uma diminuição de -15,38%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,50 variando entre R\$1,60 e R\$1,40, sem alteração em relação a semana anterior. A manga Tommy para os Estados Unidos e para a Europa tiveram cotações médias iguais, R\$1,60. Em ambos os casos os valores variaram entre R\$ 1,80 e R\$1,50. Na comparação com a semana anterior, a Tommy para os Estados Unidos teve queda de -9% e a Tommy para a Europa de -6%.
