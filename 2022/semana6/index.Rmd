...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,42, variando entre R\$1,70 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,47. Em 2020, o preço deflacionado é de R\$2,04 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 2,25). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com pouca oferta. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um pequeno aumento, de 0,71\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram os mesmos da semana anterior, mantendo os R\$1,76, variando entre R\$2,00 e R\$1,50. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,27, maior do que o preço deflacionado de 2020 (R\$1,68), mas menor do que o preço de 2021 (R\$2,36).
