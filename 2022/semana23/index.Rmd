...
library(lubridate)
last <- as.Date("2022-06-03")
today <- as.Date("2022-06-10")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,76, variando entre R\$2,00 e R\$1,50. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,27. Em 2020, o preço deflacionado é de R\$4,68 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,78. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um diminuição de -9,74\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,19, variando entre R\$2,50 e R\$1,90. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,87, menor que o preço deflacionado de 2020 (R\$4,34), mas é maior que o preço de 2021 (R\$1,12). Em relação à semana anterior os preços tiveram um aumento de 20,99%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,46, variando entre R\$2,80 e R\$2,20. isto representa um aumento de 11,82% em relação à semana anterior. No caso da Tommy para os Estados Unidos o preço médio foi de R\$2,33, variando entre o mínimo de R\$2,50 e o máximo de R\$2,00. 
