...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,42, variando entre R\$1,80 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,25. Em 2020, o preço deflacionado é de R\$1,98 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 4,00). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com pouca oferta. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 5,19\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,60, variando entre R\$2,00 e R\$1,30. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,91, menor do que o preço deflacionado de 2020 (R\$1,80), e também menor do que o preço de 2021 (R\$3,51). Em relação à semana anterior os preços tiveram uma nova queda, bastante expressiva, de -20,40%.

A tendência histórica de preços estimada continua com viés de baixa. Por outro lado, pela sazonalidade, o preço de Tommy pode continuar declinando nas próximas semanas e o preço de Palmer continuar aumentando.

Nos dados de exportação, os preços de manga Palmer caíram em relação à semana anterior, chegando a R\$1,83 (-7,57%), variando entre R\$2,00 e R\$1,60. 
