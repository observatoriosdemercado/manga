...
library(lubridate)
last <- as.Date("2022-07-15")
today <- as.Date("2022-07-22")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,12, variando entre R\$2,50 e R\$1,90. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,51. Em 2020, o preço deflacionado é de R\$3,78 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,10. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -3,64\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,58, variando entre R\$2,80 e R\$2,20. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,51, mas menor que o preço deflacionado de 2020 (R\$3,46) e maior que o preço de 2021 (R\$1,26). Em relação à semana anterior os preços tiveram uma forte queda de -7,19%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,58 variando entre R\$2,80 e R\$2,40. Isto representa uma queda de -4,09\% em relação à semana anterior. No caso da Tommy para a Europa o preço médio foi de R\$2,58, variando entre o mínimo de R\$2,80 e o máximo de R\$2,30. 
