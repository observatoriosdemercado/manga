...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 68 pessoas, ou seja, o total de contratações (1.285) foi menor do que o total de demissões (1.217). Em relação ao mesmo mês do ano passado, se tem uma melhoria no saldo total (-116 em 2021 e 68 em 2022), pois não foi negativo. Nos dez meses do ano, contudo, são 1.835 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados no mês, 829 são do sexo masculino e 456 do sexo feminino. Em relação à idade, mais da metade (56%) se concentra abaixo dos 30 anos: 224 até 21 anos, 207 até 24 anos, 158 até 27 anos e 126 até 30 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (566). Do total de contratados, 44,05% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (230) e médio incompleto (221) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
