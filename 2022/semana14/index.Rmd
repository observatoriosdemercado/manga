...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,40, variando entre R\$1,60 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,91. Em 2020, o preço deflacionado é de R\$1,34 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 3,39). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com oferta limitada no Vale. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -0,71\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,52, variando entre R\$1,90 e R\$1,20. Este valor é mais baixo do que a média histórica para esta semana, R\$ 3,00, menor do que o preço deflacionado de 2021 (R\$1,96), mas supera o preço de 2020 (R\$1,18). Em relação à semana anterior os preços tiveram um aumento de 10,14%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` reduziram em relação à semana anterior, chegando a R\$2,10 (-1,87%), variando entre R\$2,50 e R\$1,70.
