...
library(lubridate)
last <- as.Date("2022-11-25")
today <- as.Date("2022-12-02")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,70, variando entre R\$0,95 e R\$0,60. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$1,90. Em 2020, o preço deflacionado é de R\$0,63 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 2,85. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -26,32%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,35, variando entre R\$0,50 e R\$0,25. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,13, menor que o preço deflacionado de 2020 (R\$0,40) e que o preço de 2021 (R\$1,30). Em relação à semana anterior os preços ficaram estáveis.

No caso de manga de exportação, a Manga Kent teve uma média de R\$1,48, variando entre R\$1,70 e R\$1,20.
