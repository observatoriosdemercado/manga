...
library(lubridate)
last <- as.Date("2022-10-21")
today <- as.Date("2022-10-28")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,24, variando entre R\$1,50 e R\$0,90. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,55. Em 2020, o preço deflacionado é de R\$1,49 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,13. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -0,80%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,07, variando entre R\$1,20 e R\$0,80. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,33, mas é maior que o preço deflacionado de 2020 (R\$0,94) e é maior que o preço de 2021 (R\$0,97). Em relação à semana anterior os preços tiveram uma redução de -4,46%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,59 variando entre R\$1,80 e R\$1,20, queda de -2% em relação à semana anterior. A manga Tommy para os Estados Unidos foi cotada na média de R\$1,33, variando entre R\$ 1,50 e R\$1,15, redução de -9%. A Kent foi cotada a R\$2,33 na média, variando entre R\$2,50 e R\$2,20, aumento de 7%. 
