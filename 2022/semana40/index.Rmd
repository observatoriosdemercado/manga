...
library(lubridate)
last <- as.Date("2022-09-30")
today <- as.Date("2022-10-07")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,11, variando entre R\$1,30 e R\$0,90. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,85. Em 2020, o preço deflacionado é de R\$1,62 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,15. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram estáveis.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,09, variando entre R\$1,40 e R\$0,90. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,14, mas é maior que o preço deflacionado de 2020 (R\$0,93) e é maior que o preço de 2021 (R\$0,63). Em relação à semana anterior os preços tiveram uma pequena diminuição de -0,91%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,50 variando entre R\$1,70 e R\$1,20, sem alteração em relação a semana anterior. A manga Tommy para os Estados Unidos foi cotada na médias de R\$1,60, variando entre R\$ 1,80 e R\$1,40. Na comparação com a semana anterior, a Tommy para os Estados Unidos ficou com a cotação estável.
