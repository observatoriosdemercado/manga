...
library(lubridate)
last <- as.Date("2022-04-08")
today <- as.Date("2022-04-15")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,45, variando entre R\$2,20 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,93. Em 2020, o preço deflacionado é de R\$1,57 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 3,17). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com as fortes chuvas que ocorrerão na região. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 3,57\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,71, variando entre R\$2,00 e R\$1,40. Este valor é mais baixo do que a média histórica para esta semana, R\$ 3,08, mas supera o preço deflacionado de 2021 (R\$1,10) e o preço de 2020 (R\$1,43). Em relação à semana anterior os preços tiveram um novo aumento, de 12,50%, o terceiro consecutivo.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` reduziram em relação à semana anterior, chegando a R\$2,06 (-1,90%), variando entre R\$2,20 e R\$1,40.
