...
library(lubridate)
last <- as.Date("2022-07-08")
today <- as.Date("2022-07-15")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,20, variando entre R\$2,70 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,32. Em 2020, o preço deflacionado é de R\$3,70 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,27. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -3,93\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,78, variando entre R\$3,50 e R\$2,40. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,70, mas menor que o preço deflacionado de 2020 (R\$3,18) e maior que o preço de 2021 (R\$1,53). Em relação à semana anterior os preços tiveram uma queda de -1,07%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,69 variando entre R\$2,80 e R\$2,50. Isto representa um crescimento de 1,89\% em relação à semana anterior. No caso da Tommy para a Europa o preço médio foi de R\$3,20, variando entre o mínimo de R\$3,60 e o máximo de R\$3,00, uma estabilidade em relação à semana anterior. 
