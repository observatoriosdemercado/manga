...
w11 <- as.Date("2022-03-18")
last <- as.Date("2022-03-25")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,41, variando entre R\$1,50 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,68. Em 2020, o preço deflacionado é de R\$1,56 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é mais alto (R\$ 3,69). Assim, em 2022, o preço está menor do que em anos anteriores, mesmo com oferta limitada no Vale. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -2,08\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,38, variando entre R\$1,60 e R\$1,00. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,85, menor do que o preço deflacionado de 2021 (R\$1,84), mas supera o preço de 2020 (R\$1,19). Em relação à semana anterior os preços tiveram um aumento expressivo, de 17,95%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` aumentaram em relação à semana anterior, chegando a R\$2,14 (8,63%), variando entre R\$2,40 e R\$1,80.
