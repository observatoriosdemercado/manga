...
library(lubridate)
last <- as.Date("2022-08-26")
today <- as.Date("2022-09-02")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,39, variando entre R\$1,50 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,22. Em 2020, o preço deflacionado é de R\$2,34 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,69. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -3,47\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,43, variando entre R\$1,60 e R\$1,30. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,33, menor que o preço deflacionado de 2020 (R\$2,28) e que o preço de 2021 (R\$1,68). Em relação à semana anterior os preços tiveram um aumento de 28,83%.

Nos dados de exportação, os preços médios de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$1,80 variando entre R\$1,90 e R\$1,70. Isto representa um aumento de 3,44\% em relação à semana anterior. 
