...
library(lubridate)
last <- as.Date("2022-11-04")
today <- as.Date("2022-11-11")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,22, variando entre R\$1,40 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,28. Em 2020, o preço deflacionado é de R\$1,34 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,43. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 12,96%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,68, variando entre R\$0,85 e R\$0,60. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,54, maior que o preço deflacionado de 2020 (R\$0,61) e menor que o preço de 2021 (R\$1,09). Em relação à semana anterior os preços tiveram uma redução de -13,92%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,60 variando entre R\$1,80 e R\$1,40, aumento de 4% em relação à semana anterior. A manga Kent foi cotada a R\$2,07 na média, variando entre R\$2,30 e R\$1,80, queda de -8%. 
