...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,98, variando entre R\$2,30 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,41. Em 2020, o preço deflacionado é de R\$3,01 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,78. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -2,46\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,92, variando entre R\$2,10 e R\$1,70. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,42, menor que o preço deflacionado de 2020 (R\$2,65) e maior que o preço de 2021 (R\$0,74). Em relação à semana anterior os preços tiveram uma queda de -3,03%.
