...
library(lubridate)
last <- as.Date("2022-08-12")
today <- as.Date("2022-08-19")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,74, variando entre R\$1,90 e R\$1,50. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,43. Em 2020, o preço deflacionado é de R\$2,75 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,63. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma redução de -12,12\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,62, variando entre R\$1,95 e R\$1,40. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,66, menor que o preço deflacionado de 2020 (R\$2,44) e maior que o preço de 2021 (R\$0,96). Em relação à semana anterior os preços tiveram uma queda expressiva de -15,62%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$1,90 variando entre R\$2,00 e R\$1,80. Isto representa uma queda de -17\% em relação à semana anterior. No caso da Tommy para a Europa e para os Estados Unidos o preço médio foi de R\$2,17, variando entre o mínimo de R\$1,80 e o máximo de R\$2,50. 
