...
library(lubridate)
last <- as.Date("2022-10-28")
today <- as.Date("2022-11-04")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,08, variando entre R\$1,30 e R\$0,90. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,22. Em 2020, o preço deflacionado é de R\$1,36 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,06. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -12,90%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,79, variando entre R\$1,00 e R\$0,70. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,53, menor que o preço deflacionado de 2020 (R\$0,81) e menor que o preço de 2021 (R\$1,08). Em relação à semana anterior os preços tiveram uma redução de -26,17%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,54 variando entre R\$1,80 e R\$1,20, queda de -3% em relação à semana anterior. A manga Tommy para a Europa foi cotada  na média R\$1,36, variando entre R\$1,60 e R\$1,10 e Kent foi R\$2,25 na média, variando entre R\$2,30 e R\$2,20, queda de -3%. 
