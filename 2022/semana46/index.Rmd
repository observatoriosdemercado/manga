...
library(lubridate)
last <- as.Date("2022-11-11")
today <- as.Date("2022-11-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,03, variando entre R\$1,20 e R\$0,80. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,23. Em 2020, o preço deflacionado é de R\$1,13 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 1,99. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -15,57%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,55, variando entre R\$0,70 e R\$0,40. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,37, maior que o preço deflacionado de 2020 (R\$0,51) e menor que o preço de 2021 (R\$1,07). Em relação à semana anterior os preços tiveram uma redução de -19,12%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,36 variando entre R\$1,50 e R\$1,20, queda de -15% em relação à semana anterior. A manga Kent foi cotada a R\$1,98 na média, variando entre R\$2,30 e R\$1,80, queda de -4%. No caso da Tommy, o preço médio foi de R\$0,98, variando entre R\$1,20 e R\$0,80.
