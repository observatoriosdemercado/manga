...
library(lubridate)
last <- as.Date("2022-06-10")
today <- as.Date("2022-06-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,31, variando entre R\$2,80 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,24. Em 2020, o preço deflacionado é de R\$4,34 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,80. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 8,45\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,54, variando entre R\$2,80 e R\$2,20. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,92, menor que o preço deflacionado de 2020 (R\$3,89), mas é maior que o preço de 2021 (R\$1,17). Em relação à semana anterior os preços tiveram um aumento de 15,98%.

Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` foram R\$2,59, variando entre R\$2,70 e R\$2,50. isto representa um aumento de 5,28% em relação à semana anterior. No caso da Tommy para a Europa o preço médio foi de R\$2,65, variando entre o mínimo de R\$2,50 e o máximo de R\$2,70. 
