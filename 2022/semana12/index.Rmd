...
Nos dados de exportação, os preços de manga Palmer  na semana `r strftime(today, format = "%V de %Y")` aumentaram em relação à semana anterior, chegando a R\$1,97 (7,65%), variando entre R\$2,20 e R\$1,70. A safra peruana praticamente está encerrada e isto abre oportunidade para os produtores brasileiros. 
