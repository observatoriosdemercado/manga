...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,95, variando entre R\$1,10 e R\$0,75. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$2,26. Em 2020, o preço deflacionado é de R\$0,63 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 2,85. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -7,77%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,35, variando entre R\$0,50 e R\$0,30. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,24, menor que o preço deflacionado de 2020 (R\$0,49) e que o preço de 2021 (R\$1,16). Em relação à semana anterior os preços tiveram uma redução de -36,36%.
