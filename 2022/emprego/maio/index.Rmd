...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 165 pessoas, ou seja, o total de contratações (841) foi maior do que o total de demissões (676). Em relação ao mesmo mês do ano passado, se tem uma grande redução no saldo total (355 em 2021 e 165 em 2022). Nos cinco meses, são 1099 empregos líquidos a menos do que no mesmo período de 2021. 
