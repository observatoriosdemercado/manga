...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -678 pessoas, ou seja, o total de contratações (828) foi menor do que o total de demissões (1.506). Em relação ao mesmo mês do ano passado, se tem uma melhoria no saldo total (-1.438 em 2021 e -678 em 2022), com menos pessoas perdendo emprego. Nos onze meses do ano, contudo, são 1.075 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados no mês, 481 são do sexo masculino e 347 do sexo feminino. Em relação à idade, mais da metade (52,2%) se concentra abaixo dos 30 anos: 130 até 21 anos, 126 até 24 anos, 100 até 27 anos e 76 até 30 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (378). Do total de contratados, 45,65% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (127) e médio incompleto (146) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
...
#Entrando dados no R
dados1 <- read.csv2('novembro_2022.csv', header=T, sep=";", dec = ".")
