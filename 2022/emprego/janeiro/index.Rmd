...
O saldo de empregos na mangicultura em `r strftime(anterior, format = "%B de %Y")` no Vale do São Francisco é de -226 pessoas, ou seja, o total de contratações (516) foi menor do que o total de demissões (742).
