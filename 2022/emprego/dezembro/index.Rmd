...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -2.072 pessoas, ou seja, o total de contratações (335) foi bem menor do que o total de demissões (2.407). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-1.573 em 2021 e -2.072 em 2022), com mais pessoas perdendo emprego. No ano de 2022, contudo, são 1.574 empregos líquidos a menos do que em 2021. 

Dos contratados no mês, 242 são do sexo masculino e 93 do sexo feminino. Em relação à idade, 44,48% se concentra abaixo dos 27 anos: 54 até 21 anos, 42 até 24 anos e 53 até 27 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (133). Do total de contratados, 39,70% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (46), fundamental completo (47) e médio incompleto (50) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
