...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de -32 pessoas, ou seja, o total de contratações (749) foi menor do que o total de demissões (781). Em relação ao mesmo mês do ano passado, se tem uma queda enorme no saldo total (749 em 2021 e -32 em 2022). No quadrimestre, são 909 empregos líquidos a menos do que no mesmo período de 2021. 
...
#dados_04_vsf$sexo <- lapply(dados_04_vsf$sexo, factor)
...
<center> Dashboard Mercado de Manga [https://bit.ly/3KTVLkJ](Dashboard Mercado de Manga) </center>
