...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 424 pessoas, ou seja, o total de contratações (1152) foi maior do que o total de demissões (728). Em relação ao mesmo mês do ano passado, se tem uma queda no saldo total (609 em 2021 e 424 em 2022). No trimestre, são 461 empregos líquidos a menos do que no mesmo período de 2021. 
