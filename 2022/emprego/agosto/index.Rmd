...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 1.534 pessoas, ou seja, o total de contratações (2.253) foi maior do que o total de demissões (719). Em relação ao mesmo mês do ano passado, se tem uma aumento no saldo total (1477 em 2021 e 1534 em 2022). Nos oito meses, contudo, ainda são 1.640 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados no mês, 1.359 são do sexo masculino e 894 do sexo feminino. Em relação à idade, aproximadamente a metade se concentra abaixo dos 30 anos: 395 até 21 anos, 322 até 24 anos, 273 até 27 anos e 165 até 30 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.023). Do total de contratados, 45,41% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (308) e médio incompleto (434) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
