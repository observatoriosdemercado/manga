...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 629 pessoas, ou seja, o total de contratações (1.381) foi menor do que o total de demissões (752). Em relação ao mesmo mês do ano passado, se tem uma redução no saldo total (854 em 2021 e 629 em 2022). Nos sete meses, são 1.697 empregos líquidos a menos do que no mesmo período de 2021. 
