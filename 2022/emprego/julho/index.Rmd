...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de 629 pessoas, ou seja, o total de contratações (1.381) foi maior do que o total de demissões (752). Em relação ao mesmo mês do ano passado, se tem uma redução no saldo total (854 em 2021 e 629 em 2022). Nos sete meses, são 1.697 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados no mês, 1.001 são do sexo masculino e 380 do sexo feminino. Em relação à idade, aproximadamente a metade se concentra abaixo dos 30 anos: 222 até 21 anos, 200 até 24 anos, 163 até 27 anos e 127 até 30 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (585). Do total de contratados, 42,36% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (246) e médio incompleto (246) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
