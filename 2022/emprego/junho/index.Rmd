...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi de -55 pessoas, ou seja, o total de contratações (683) foi menor do que o total de demissões (738). Em relação ao mesmo mês do ano passado, se tem uma grande redução no saldo total (318 em 2021 e -55 em 2022). Nos seis meses, são 1.472 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados no mês, 449 são do sexo masculino e 234 do sexo feminino. Em relação à idade, aproximadamente a metade se concentra abaixo dos 30 anos: 108 até 21 anos, 101 até 24 anos, 87 até 27 anos e 58 até 30 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (297). Do total de contratados, 43,48% possuem este nível de escolaridade. Este grau de estudo junto com 6 ao 9 ano do ensino fundamental (111) e médio incompleto (120) representam a grande parte dos contratados na mangicultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
