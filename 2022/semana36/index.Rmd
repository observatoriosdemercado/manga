...
library(lubridate)
last <- as.Date("2022-09-02")
today <- as.Date("2022-09-09")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,49, variando entre R\$1,70 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,28. Em 2020, o preço deflacionado é de R\$2,32 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,74. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram um aumento de 7,19\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,52, variando entre R\$1,70 e R\$1,40. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,29, menor que o preço deflacionado de 2020 (R\$2,29) e que o preço de 2021 (R\$1,61). Em relação à semana anterior os preços tiveram um aumento de 6,29%.
