...
data <- as.Date("2022-06-24") #ajustar semanalmente
...
anterior <- as.Date("2022-04-01")
atual <-  as.Date("2022-05-01") #ultimo mes disponibilizado
today <- as.Date("2022-06-10") #data para o IGPI - ultima semana do preço
mes <- 5
...
#Entrando dados no R
dados1 <- read.csv2('abril_2022.csv', header=T, sep=";", dec = ".")
