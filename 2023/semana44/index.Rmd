...
library(lubridate)
last <- as.Date("2023-10-27")
today <- as.Date("2023-11-03")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,91 variando entre R\$3,30 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,01. Em 2021, o preço deflacionado é de R\$1,00 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,03. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -9,63%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,59, variando entre R\$1,80 e R\$1,40. Este valor é maior do que a média histórica para esta semana (R\$1,37), do que o preço de 2022 (R\$0,75) e que o preço deflacionado de 2021 (R\$1,02). Em relação à semana anterior os preços caíram -7,02%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,13, variando entre R\$4,50 e R\$3,60, aumento de 1% em relação a semana passada. A Tommy tanto para a Europa quanto para os Estados Unidos teve média de preço de R\$2,58, variando entre R\$3,10 e R\$1,80, redução de -6% em relação à semana anterior. 
