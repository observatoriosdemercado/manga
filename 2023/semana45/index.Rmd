...
library(lubridate)
last <- as.Date("2023-11-03")
today <- as.Date("2023-11-10")
sem_ano <- 45 #ajustar semanalmente
```
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,08 variando entre R\$3,50 e R\$2,70. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,09. Em 2021, o preço deflacionado é de R\$1,37 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,17. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 5,84%, depois de 4 semanas de reduções.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,61, variando entre R\$2,00 e R\$1,40. Este valor é maior do que a média histórica para esta semana (R\$1,38), do que o preço de 2022 (R\$0,65) e que o preço deflacionado de 2021 (R\$1,05). Em relação à semana anterior os preços aumentaram 1,26%, depois de 4 semanas de reduções. 

Sobre os preços de exportação, a Tommy tanto para a Europa quanto para os Estados Unidos teve média de preço de R\$2,10, variando entre R\$2,80 e R\$1,70, redução de -19% em relação à semana anterior. 
