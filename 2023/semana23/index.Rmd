...
library(lubridate)
last <- as.Date("2023-06-02")
today <- as.Date("2023-06-09")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,34 variando entre R\$1,60 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,24. Em 2021, o preço deflacionado é de R\$0,74 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,00. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 2,29%. O primeiro aumento depois de 7 semanas de quedas consecutivas.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,73, variando entre R\$2,00 e R\$1,30. Este valor é menor do que a média histórica para esta semana (R\$ 2,87) e que o preço de 2022 (R\$2,06). Porém, é maior que o preço deflacionado de 2021 (R\$1,05). Em relação à semana anterior os preços aumentaram 30,08%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$1,77, variando entre R\$1,90 e R\$1,70, redução de 2% em relação a semana anterior.
