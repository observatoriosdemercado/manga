...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,58 variando entre R\$3,20 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,45. Em 2021, o preço deflacionado é de R\$1,10 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,18. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -4,80%. É a terceira semana consecutiva de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,55, variando entre R\$3,00 e R\$2,30. Este valor é menor do que a média histórica para esta semana, R\$ 2,76, mas é maior que o preço deflacionado de 2021 (R\$0,97) e que o preço de 2022 (R\$2,53). Em relação à semana anterior os preços reduziram -3,77%.
