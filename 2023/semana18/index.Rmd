...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,58 variando entre R\$3,20 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,45. Em 2021, o preço deflacionado é de R\$1,10 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,18. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -4,80%. É a terceira semana consecutiva de queda de preços.
