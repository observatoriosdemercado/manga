...
library(lubridate)
last <- as.Date("2023-04-14")
today <- as.Date("2023-04-21")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,79 variando entre R\$3,50 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,77. Em 2021, o preço deflacionado é de R\$1,82 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,53. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -7,92%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,51, variando entre R\$3,00 e R\$2,20. Este valor é menor do que a média histórica para esta semana, R\$ 2,97, mas é maior que o preço deflacionado de 2021 (R\$0,84) e que o preço de 2022 (R\$1,92). Em relação à semana anterior os preços diminuíram -15,77%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,53, variando entre R\$3,80 e R\$3,30, um aumento de 1% em relação a semana anterior. No caso da Tommy, para a Europa, o preço médio foi R\$2,90, variando entre R\$3,10 e R\$2,50, queda de 10%.
