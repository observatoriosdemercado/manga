...
library(lubridate)
last <- as.Date("2023-09-22")
today <- as.Date("2023-09-29")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,88 variando entre R\$3,20 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,66. Em 2021, o preço deflacionado é de R\$1,12 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,05. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 12,94%, a quarta alta seguida. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,07, variando entre R\$3,50 e R\$2,70. Este valor é maior do que a média histórica para esta semana (R\$1,20), do que o preço de 2022 (R\$1,04) e que o preço deflacionado de 2021 (R\$0,73). Em relação à semana anterior os preços aumentaram 19,92%, a quarta alta seguida. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,35, variando entre R\$3,70 e R\$2,90, aumento de 17% em relação a semana passada.
