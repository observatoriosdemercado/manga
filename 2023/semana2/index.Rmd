...
library(lubridate)
last <- as.Date("2023-01-06")
today <- as.Date("2023-01-13")
sem_ano <- 02 #ajustar semanalmente
```
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,96, variando entre R\$1,30 e R\$0,70. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,42. Em 2021, o preço deflacionado é de R\$1,25 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,98. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 14,29%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,02, variando entre R\$1,30 e R\$0,80. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,94, menor que o preço deflacionado de 2021 (R\$2,07) e que o preço de 2022 (R\$1,87). Em relação à semana anterior os preços diminuíram -20,31%.
