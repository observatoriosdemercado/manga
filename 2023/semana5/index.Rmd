...
library(lubridate)
last <- as.Date("2023-01-27")
today <- as.Date("2023-02-03")
sem_ano <- 05 #ajustar semanalmente
```
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,42, variando entre R\$1,80 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,49. Em 2021, o preço deflacionado é de R\$1,87 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,43. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 32,71%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,12, variando entre R\$1,30 e R\$0,90. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,09, menor que o preço deflacionado de 2021 (R\$1,91) e que o preço de 2022 (R\$1,79). Em relação à semana anterior os preços aumentaram 55,56%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,03, variando entre R\$2,30 e R\$1,80. Em relação a semana anterior, isto representa um aumento de 21,56%.
