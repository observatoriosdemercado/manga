...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,04 variando entre R\$2,50 e R\$1,70. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,06. Em 2021, o preço deflacionado é de R\$0,76 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,90. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 15,91%, sexta alta consecutiva. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,61, variando entre R\$2,80 e R\$2,20. Este valor é maior que a média histórica para esta semana (R\$ 2,11), maior do que o preço de 2022 (R\$1,85) e que o preço deflacionado de 2021 (R\$0,77). Em relação à semana anterior os preços aumentaram 23,70%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,22, variando entre R\$2,50 e R\$1,90, alta de 7% em relação a semana passada. 
