...
library(lubridate)
last <- as.Date("2023-10-13")
today <- as.Date("2023-10-20")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,33 variando entre R\$3,80 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,49. Em 2021, o preço deflacionado é de R\$0,99 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,19. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -6,46%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,85, variando entre R\$2,20 e R\$1,40. Este valor é maior do que a média histórica para esta semana (R\$1,25), do que o preço de 2022 (R\$1,07) e que o preço deflacionado de 2021 (R\$0,43). Em relação à semana anterior os preços caíram fortemente, -27,73%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,18, variando entre R\$4,30 e R\$4,10, queda de -6% em relação a semana passada. A Tommy para a Europa e para os Estados Unidos teve média de preço de R\$3,25, variando entre R\$3,60 e R\$3,00, redução de -13% e -10%, respectivamente,  em relação à semana anterior. 
