...
library(lubridate)
last <- as.Date("2023-02-17")
today <- as.Date("2023-02-24")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,28, variando entre R\$2,50 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,92. Em 2021, o preço deflacionado é de R\$3,35 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,50. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 18,75%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,64, variando entre R\$2,90 e R\$2,50. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,90, menor que o preço deflacionado de 2021 (R\$3,50), mas é mais alto que o preço de 2022 (R\$2,32). Em relação à semana anterior os preços aumentaram 11,86%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,67, variando entre R\$3,00 e R\$2,30.
