...
library(lubridate)
last <- as.Date("2023-06-30")
today <- as.Date("2023-07-07")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,43 variando entre R\$1,70 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,12. Em 2021, o preço deflacionado é de R\$1,25 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,13. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,52%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,86, variando entre R\$2,20 e R\$1,60. Este valor é menor do que a média histórica para esta semana (R\$ 2,51) e que o preço de 2022 (R\$2,61). Porém, é maior que o preço deflacionado de 2021 (R\$1,29). Em relação à semana anterior os preços aumentaram 1,64%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$1,94, variando entre R\$2,15 e R\$1,50, aumento de 6% em relação a semana passada. O preço médio de Tommy para a Europa foi R\$ 2,40, variando entre R\$ 2,50 e R\$2,20
