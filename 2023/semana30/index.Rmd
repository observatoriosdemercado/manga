...
library(lubridate)
last <- as.Date("2023-07-21")
today <- as.Date("2023-07-28")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,76 variando entre R\$2,10 e R\$1,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,13. Em 2021, o preço deflacionado é de R\$0,81 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,07. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,64%, a quinta alta consecutiva. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,11, variando entre R\$2,50 e R\$1,80. Este valor é praticamente igual a média histórica para esta semana (R\$ 2,13), maior do que o preço de 2022 (R\$1,94) e que o preço deflacionado de 2021 (R\$0,89). Em relação à semana anterior os preços reduziram -4,52%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,07, variando entre R\$2,20 e R\$1,90, alta de 3% em relação a semana passada. 
