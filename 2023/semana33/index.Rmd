...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,13 variando entre R\$2,30 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,10. Em 2021, o preço deflacionado é de R\$0,59 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,62. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -5,33%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,44, variando entre R\$2,70 e R\$2,30. Este valor é igual que a média histórica para esta semana, maior do que o preço de 2022 (R\$1,51) e que o preço deflacionado de 2021 (R\$0,89). Em relação à semana anterior os preços reduziram -21,04%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,60, variando entre R\$2,70 e R\$2,40, alta de 8% em relação a semana passada. 
