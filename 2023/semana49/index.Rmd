...
library(lubridate)
last <- as.Date("2023-12-01")
today <- as.Date("2023-12-08")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,05 variando entre R\$3,60 e R\$2,20. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$1,76. Em 2021, o preço deflacionado é de R\$2,48 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,70. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 25,51%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,21, variando entre R\$3,00 e R\$1,70. Este valor é maior do que a média histórica para esta semana (R\$0,96), do que o preço de 2022 (R\$0,37) e que o preço deflacionado de 2021 (R\$1,26). Em relação à semana anterior os preços aumentaram 8,33%. Em cinco semanas foram quatro altas de preços. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,02, variando entre R\$4,50 e R\$3,00, queda de -3% em relação a semana anterior. A Tommy para os Estados Unidos e Europa teve média de preço de R\$2,63 (variando entre R\$2,80 e R\$2,40) aumento de 17% em relação à semana anterior. A Kent teve média de R\$ 3,75, variando entre R\$4,00 e R\$3,50.
