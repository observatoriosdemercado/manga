...
library(lubridate)
last <- as.Date("2023-06-16")
today <- as.Date("2023-06-23")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,24 variando entre R\$1,40 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,92. Em 2021, o preço deflacionado é de R\$0,93 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,04. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -6,77%. Nas últimas dez semanas, os preços reduziram em nove delas.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,43, variando entre R\$1,80 e R\$1,30. Este valor é menor do que a média histórica para esta semana (R\$ 2,53) e que o preço de 2022 (R\$2,30). Porém, é maior que o preço deflacionado de 2021 (R\$1,15). Em relação à semana anterior os preços reduziram -13,33%.
