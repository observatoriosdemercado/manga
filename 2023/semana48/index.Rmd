...
library(lubridate)
last <- as.Date("2023-11-24")
today <- as.Date("2023-12-01")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,43 variando entre R\$2,80 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$1,68. Em 2021, o preço deflacionado é de R\$2,73 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,67. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -14,13%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,04, variando entre R\$2,50 e R\$1,50. Este valor é maior do que a média histórica para esta semana (R\$1,01), do que o preço de 2022 (R\$0,33) e que o preço deflacionado de 2021 (R\$1,25). Em relação à semana anterior os preços aumentaram 16,57%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,14, variando entre R\$4,50 e R\$4,00, aumento de 4% em relação a semana anterior. A Tommy para os Estados Unidos teve média de preço de R\$2,27 (variando entre R\$2,40 e R\$2,00) e para a Europa, R\$2,25 (variando entre R\$2,50 e R\$2,00), queda de -4% em relação à semana anterior para os Estados Unidos e -11% para a Europa.
