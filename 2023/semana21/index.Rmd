...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,50 variando entre R\$2,00 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,59. Em 2021, o preço deflacionado é de R\$0,86 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,22. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -28,57%. É a sexta semana consecutiva de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,37, variando entre R\$1,60 e R\$1,20. Este valor é menor do que a média histórica para esta semana (R\$ 3,14) e que o preço de 2022 (R\$2,02). Porém, é maior que o preço deflacionado de 2021 (R\$1,26). Em relação à semana anterior os preços reduziram -35,07%. Os preços nas ultimas nove semanas caíram em sete delas.
