...
library(lubridate)
last <- as.Date("2023-07-14")
today <- as.Date("2023-07-21")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,62 variando entre R\$2,10 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,27. Em 2021, o preço deflacionado é de R\$1,01 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,97. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,28%, a quarta alta consecutiva. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,21, variando entre R\$2,70 e R\$1,90. Este valor é menor do que a média histórica para esta semana (R\$ 2,42) e que o preço de 2022 (R\$2,40). Porém, é maior que o preço deflacionado de 2021 (R\$1,17). Em relação à semana anterior os preços aumentaram 2,31%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,01, variando entre R\$2,30 e R\$1,60, alta de 8% em relação a semana passada. 
