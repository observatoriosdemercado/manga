...
library(lubridate)
last <- as.Date("2023-03-24")
today <- as.Date("2023-03-31")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,34 variando entre R\$2,90 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,49. Em 2021, o preço deflacionado é de R\$3,75 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,40. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,33%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,28, variando entre R\$4,00 e R\$2,50. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,70, maior que o preço deflacionado de 2022 (R\$1,37), e que o preço de 2021 (R\$1,87). Em relação à semana anterior os preços reduziram -19,01%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,75, variando entre R\$3,40 e R\$2,20, um aumento de 15,54% em relação a semana anterior.
