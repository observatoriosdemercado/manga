...
library(lubridate)
last <- as.Date("2023-04-07")
today <- as.Date("2023-04-14")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,03 variando entre R\$3,50 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,67. Em 2021, o preço deflacionado é de R\$3,17 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,44. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,07%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,98, variando entre R\$3,30 e R\$2,80. Este valor é maior do que a média histórica para esta semana, R\$ 2,89, mas é maior que o preço deflacionado de 2022 (R\$1,70) e que o preço de 2021 (R\$1,10). Em relação à semana anterior os preços aumentaram 7,19%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,50, variando entre R\$3,80 e R\$3,20, um aumento de 7,36% em relação a semana anterior. No caso da Tommy, para a Europa, o preço médio foi R\$3,22, variando entre R\$3,40 e R\$2,90, aumento de 7,33%.
