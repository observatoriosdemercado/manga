...
library(lubridate)
last <- as.Date("2023-03-17")
today <- as.Date("2023-03-24")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,16 variando entre R\$2,80 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,40. Em 2021, o preço deflacionado é de R\$3,83 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,43. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -1,37%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,05, variando entre R\$4,50 e R\$3,50. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,74, maior que o preço deflacionado de 2022 (R\$1,16), e que o preço de 2021 (R\$1,95). Em relação à semana anterior os preços aumentaram 8,29%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,38, variando entre R\$2,80 e R\$2,20, uma redução de -13,45% em relação a semana anterior.
