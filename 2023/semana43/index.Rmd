...
library(lubridate)
last <- as.Date("2023-10-20")
today <- as.Date("2023-10-27")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,22 variando entre R\$3,60 e R\$2,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,30. Em 2021, o preço deflacionado é de R\$1,07 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,18. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -3,30%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,71, variando entre R\$2,00 e R\$1,40. Este valor é maior do que a média histórica para esta semana (R\$1,22), do que o preço de 2022 (R\$1,02) e que o preço deflacionado de 2021 (R\$0,92). Em relação à semana anterior os preços caíram fortemente, -7,57%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,07, variando entre R\$4,30 e R\$3,80, queda de -2% em relação a semana passada. A Tommy tanto para a Europa quanto para os Estados Unidos teve média de preço de R\$2,75, variando entre R\$3,00 e R\$2,20, redução de -15% em relação à semana anterior. 
