...
library(lubridate)
last <- as.Date("2023-08-25")
today <- as.Date("2023-09-01")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,90 variando entre R\$2,10 e R\$1,45. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,89. Em 2021, o preço deflacionado é de R\$0,64 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,31. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -5,47%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,85, variando entre R\$2,20 e R\$1,50. Este valor é menor do que a média histórica para esta semana (R\$2,15), maior do que o preço de 2022 (R\$1,35) e que o preço deflacionado de 2021 (R\$1,56). Em relação à semana anterior os preços reduziram -0,54%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,48, variando entre R\$2,80 e R\$2,10, queda de -5% em relação a semana passada. A Tommy exportação para os Estados Unidos foi vendida, na média, por R\$2,02, variando entre R\$2,50 e R\$1,80. 
