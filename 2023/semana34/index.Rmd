...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,01 variando entre R\$2,50 e R\$1,60. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,03. Em 2021, o preço deflacionado é de R\$0,62 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,34. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -5,63%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,86, variando entre R\$2,30 e R\$1,70. Este valor é menor do que a média histórica para esta semana (R\$2,47), maior do que o preço de 2022 (R\$1,03) e que o preço deflacionado de 2021 (R\$1,39). Em relação à semana anterior os preços reduziram -23,77%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,62, variando entre R\$2,80 e R\$2,30, alta de 1% em relação a semana passada. A Tommy exportação foi vendida, na média, por R\$2,22, variando entre R\$2,50 e R\$2,00. 
