...
library(lubridate)
last <- as.Date("2023-03-31")
today <- as.Date("2023-04-07")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,83 variando entre R\$3,30 e R\$2,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,63. Em 2021, o preço deflacionado é de R\$3,39 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,39. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 20,94%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,78, variando entre R\$3,50 e R\$2,30. Este valor é um pouco menor do que a média histórica para esta semana, R\$ 2,80, mas é maior que o preço deflacionado de 2022 (R\$1,51) e que o preço de 2021 (R\$1,96). Em relação à semana anterior os preços reduziram -15,24%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,26, variando entre R\$3,50 e R\$2,80, um aumento de 19% em relação a semana anterior. No caso da Tommy, para a Europa, o preço médio foi R\$3,00, variando entre R\$3,10 e R\$2,90.
