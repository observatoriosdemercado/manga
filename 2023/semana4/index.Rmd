...
library(lubridate)
last <- as.Date("2023-01-20")
today <- as.Date("2023-01-27")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,07, variando entre R\$1,30 e R\$0,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,53. Em 2021, o preço deflacionado é de R\$1,66 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,38. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 10,31%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,72, variando entre R\$0,90 e R\$0,60. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,99, menor que o preço deflacionado de 2021 (R\$2,11) e que o preço de 2022 (R\$1,46). Em relação à semana anterior os preços diminuíram -12,20%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$1,67, variando entre R\$2,00 e R\$1,50. 
