...
library(lubridate)
last <- as.Date("2023-09-01")
today <- as.Date("2023-09-08")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,97 variando entre R\$2,20 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,95. Em 2021, o preço deflacionado é de R\$0,69 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,40. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,68%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,92, variando entre R\$2,00 e R\$1,80. Este valor é menor do que a média histórica para esta semana (R\$2,13), maior do que o preço de 2022 (R\$1,43) e que o preço deflacionado de 2021 (R\$1,50). Em relação à semana anterior os preços aumentaram 3,78%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,45, variando entre R\$2,60 e R\$2,20, queda de -1,21% em relação a semana passada.
