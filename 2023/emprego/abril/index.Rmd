...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 248 pessoas, ou seja, o total de contratações (829) foi maior do que o total de demissões (581). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-32 em 2022 e 248 em 2023), com mais pessoas conseguindo emprego. Isto reflete um primeiro quadrimestre melhor da mangicultura do Vale em relação ao ano anterior. 

Dos contratados no mês, 571 são do sexo masculino e 258 do sexo feminino. Em relação à idade, 51,39% se concentra abaixo dos 30 anos: 124 pessoas até 21 anos, 127 até 24 anos, 101 ate 27 anos e 74 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (383). Do total de contratados, 46,20% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87,45% dos contratados foram pelo valor de R\$ 1.302,00, o salário mínimo nacional. O maior salário foi R\$ 10.992,00. 
