...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 1.250 pessoas, ou seja, o total de contratações (1.932) foi maior do que o total de demissões (682). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (1.534 em 2022 e 1.250 em 2023), com menos pessoas conseguindo emprego. Quando se compara os oito meses, o saldo líquido em 2023 é de 2.244 empregos, menor que o saldo de 2022, 2.516 empregos. 

Dos contratados no mês, 1.168 são do sexo masculino (60,46%) e 764 do sexo feminino. Em relação à idade, 52,33% se concentra abaixo dos 30 anos: 346 pessoas até 21 anos, 288 até 24 anos, 242 ate 27 anos e 135 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (983). Do total de contratados, 50,88% possuem este nível de escolaridade. 

Com relação aos salários pagos, 90,99% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 13.540,00. 
