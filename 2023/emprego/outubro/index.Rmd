...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -266 pessoas, ou seja, o total de contratações (861) foi menor do que o total de demissões (1.127). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (70 em 2022 e -266 em 2023), com mais pessoas perdendo emprego. Quando se compara os 10 meses, o saldo líquido em 2023 é de 2.406 empregos, menor que o saldo de 2022, 3.043 empregos. 

Dos contratados no mês, 596 são do sexo masculino (69,22%) e 265 do sexo feminino. Em relação à idade, 56,10% se concentra abaixo dos 30 anos: 159 pessoas até 21 anos, 128 até 24 anos, 114 ate 27 anos e 82 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (327). Do total de contratados, 37,98% possuem este nível de escolaridade. 

Com relação aos salários pagos, 91,06% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 6.000,00. 
