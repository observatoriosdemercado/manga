...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -266 pessoas, ou seja, o total de contratações (861) foi maior do que o total de demissões (1.127). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (70 em 2022 e -266 em 2023), com mais pessoas perdendo emprego. Quando se compara os 10 meses, o saldo líquido em 2023 é de 2.406 empregos, menor que o saldo de 2022, 3.043 empregos. 
