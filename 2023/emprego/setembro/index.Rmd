...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 428 pessoas, ou seja, o total de contratações (1.376) foi maior do que o total de demissões (948). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (457 em 2022 e 428 em 2023), com menos pessoas conseguindo emprego. Quando se compara os nove meses, o saldo líquido em 2023 é de 2.672 empregos, menor que o saldo de 2022, 2.973 empregos. 

Dos contratados no mês, 785 são do sexo masculino (57,05%) e 591 do sexo feminino. Em relação à idade, 55,31% se concentra abaixo dos 30 anos: 242 pessoas até 21 anos, 216 até 24 anos, 171 ate 27 anos e 132 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (548). Do total de contratados, 39,83% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87,43% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 6.569,00. 
