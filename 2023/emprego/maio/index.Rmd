...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 71 pessoas, ou seja, o total de contratações (647) foi maior do que o total de demissões (576). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (165 em 2022 e 71 em 2023), com menos pessoas conseguindo emprego. Quase se compara os cinco meses, o saldo líquido em 2023 é de 301 empregos, bem menor do que o saldo de 408 empregos em 2022. 

Dos contratados no mês, 470 são do sexo masculino e 177 do sexo feminino. Em relação à idade, 54,40% se concentra abaixo dos 30 anos: 111 pessoas até 21 anos, 96 até 24 anos, 84 ate 27 anos e 61 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (304). Do total de contratados, 46,99% possuem este nível de escolaridade. 

Com relação aos salários pagos, 72,49% dos contratados foram pelo valor de R\$ 1.320,00, o salário mínimo nacional. O maior salário foi R\$ 18.000,00. 
