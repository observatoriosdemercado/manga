...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -1.038 pessoas, ou seja, o total de contratações (502) foi menor do que o total de demissões (1.540). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-678 em 2022 e -1.038 em 2023), com mais pessoas perdendo emprego. Quando se compara os 11 meses, o saldo líquido em 2023 é de 1.368 empregos, menor que o saldo de 2022, 2.365 empregos. 

Dos contratados no mês, 347 são do sexo masculino (69,12%) e 155 do sexo feminino. Em relação à idade, 46,61% se concentra abaixo dos 30 anos: 80 pessoas até 21 anos, 60 até 24 anos, 50 ate 27 anos e 44 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (266). Do total de contratados, 52,99% possuem este nível de escolaridade. 

Com relação aos salários pagos, 76,29% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 6.375,00. 
...
#Entrando dados no R
dados1 <- read.csv2('novembro_2023.csv', header=T, sep=";", dec = ".")
