...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -1.312 pessoas, ou seja, o total de contratações (440) foi menor do que o total de demissões (1.752). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-2.071 em 2022 e -1.312 em 2023), com menos pessoas perdendo emprego. Quando se compara os 12 meses do ano, o saldo líquido em 2023 é de 56 empregos, menor que o saldo de 2022, 294 empregos. 

Dos contratados no mês, 296 são do sexo masculino (67,27%) e 144 do sexo feminino. Em relação à idade, 50,68% se concentra abaixo dos 30 anos: 74 pessoas até 21 anos, 66 até 24 anos, 47 ate 27 anos e 36 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (161). Do total de contratados, 36,59% possuem este nível de escolaridade. 

Com relação aos salários pagos, 85,91% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 7.633,00. 
...
#Entrando dados no R
dados1 <- read.csv2('dezembro_2023.csv', header=T, sep=";", dec = ".")
...
g4 <- ggplot(data = subclasse_positivos, aes(x = grau_instrucao, y = ..count..)) +
  geom_bar(fill='steelblue')+
    scale_y_continuous(limits=c(0,180), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
