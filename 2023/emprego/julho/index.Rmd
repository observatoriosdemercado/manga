...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 209 pessoas, ou seja, o total de contratações (848) foi maior do que o total de demissões (639). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-55 em 2022 e 209 em 2023), com mais pessoas conseguindo emprego. Quase se compara os seis meses, o saldo líquido em 2023 é de 510 empregos, bem maior do que o saldo de 353 empregos em 2022. 

Dos contratados no mês, 569 são do sexo masculino e 279 do sexo feminino. Em relação à idade, 49,5% se concentra abaixo dos 30 anos: 134 pessoas até 21 anos, 123 até 24 anos, 100 ate 27 anos e 63 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (402). Do total de contratados, 47,41% possuem este nível de escolaridade. 

Com relação aos salários pagos, 59,91% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 12.091,00. 
