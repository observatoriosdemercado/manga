...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 484 pessoas, ou seja, o total de contratações (1.103) foi maior do que o total de demissões (619). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (629 em 2022 e 484 em 2023), com menos pessoas conseguindo emprego. Quando se compara os sete meses, o saldo líquido em 2023 é de 994 empregos, praticamente o mesmo o saldo de 2022, 982 empregos. 

Dos contratados no mês, 752 são do sexo masculino e 351 do sexo feminino. Em relação à idade, 52,4% se concentra abaixo dos 30 anos: 193 pessoas até 21 anos, 170 até 24 anos, 126 ate 27 anos e 89 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (588). Do total de contratados, 53,31% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87,94% dos contratados foram pelo valor de R\$ 1.354,00, o piso do salário acordado na CCT 2023, acima do salário mínimo nacional. O maior salário foi R\$ 11.355,00. 
...
#dados_07_vsf$sexo <- lapply(dados_07_vsf$sexo, factor)
