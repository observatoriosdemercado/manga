...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -363 pessoas, ou seja, o total de contratações (352) foi menor do que o total de demissões (715). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-226 em 2021 e -363 em 2022), com mais pessoas perdendo emprego. 

Dos contratados no mês, 270 são do sexo masculino e 82 do sexo feminino. Em relação à idade, 50,3% se concentra abaixo dos 30 anos: 52 até 21 anos, 49 até 24 anos 44 ate 27 anos e 32 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (164). Do total de contratados, 46,59% possuem este nível de escolaridade. 

Com relação aos salários pagos, 70,45% dos contratados foram pelo valor de R$ 1.302,00, o salário mínimo nacional. 
