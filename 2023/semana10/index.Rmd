...
library(lubridate)
last <- as.Date("2023-03-03")
today <- as.Date("2023-03-10")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,23 variando entre R\$3,00 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,04. Em 2021, o preço deflacionado é de R\$4,37 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,34. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -7,85%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,18, variando entre R\$3,50 e R\$2,50. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,94, maior que o preço deflacionado de 2022 (R\$1,99), mas é mais baixo que o preço de 2021 (R\$4,13). Em relação à semana anterior os preços aumentaram 4,61%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,65, variando entre R\$3,00 e R\$2,50, uma redução de -3% em relação a semana anterior. 
