...
library(lubridate)
last <- as.Date("2023-05-26")
today <- as.Date("2023-06-02")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,31 variando entre R\$1,70 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,46. Em 2021, o preço deflacionado é de R\$0,78 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,88. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -12,67%. É a sétima semana consecutiva de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,33, variando entre R\$1,70 e R\$1,00. Este valor é menor do que a média histórica para esta semana (R\$ 3,12) e que o preço de 2022 (R\$1,74). Porém, é maior que o preço deflacionado de 2021 (R\$1,25). Em relação à semana anterior os preços reduziram -2,92%. Os preços nas ultimas dez semanas caíram em oito delas.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$1,80, variando entre R\$2,00 e R\$1,70.
