...
library(lubridate)
last <- as.Date("2023-06-09")
today <- as.Date("2023-06-16")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,33 variando entre R\$1,50 e R\$1,10. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,18. Em 2021, o preço deflacionado é de R\$0,75 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,17. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -0,75%. Nas últimas nove semanas, os preços reduziram em oito delas.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,65, variando entre R\$2,00 e R\$1,40. Este valor é menor do que a média histórica para esta semana (R\$ 2,87) e que o preço de 2022 (R\$2,39). Porém, é maior que o preço deflacionado de 2021 (R\$1,11). Em relação à semana anterior os preços reduziram -4,62%.

Sobre os preços de exportação, a Palmer foi vendida por R\$1,80, aumento de 2% em relação a semana anterior.
