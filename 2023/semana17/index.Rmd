...
library(lubridate)
last <- as.Date("2023-04-21")
today <- as.Date("2023-04-28")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,71 variando entre R\$3,30 e R\$2,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,65. Em 2021, o preço deflacionado é de R\$1,33 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,77. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -2,87%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,65, variando entre R\$3,00 e R\$2,00. Este valor é menor do que a média histórica para esta semana, R\$ 2,90, mas é maior que o preço deflacionado de 2021 (R\$0,99) e que o preço de 2022 (R\$2,23). Em relação à semana anterior os preços aumentaram 5,58%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,36, variando entre R\$3,60 e R\$3,00, uma queda de -5% em relação a semana anterior. No caso da Tommy, para a Europa, o preço médio foi R\$3,10, variando entre R\$3,20 e R\$3,00, aumento de 7%.
