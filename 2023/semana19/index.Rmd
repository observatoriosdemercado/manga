...
library(lubridate)
last <- as.Date("2023-05-05")
today <- as.Date("2023-05-12")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,48 variando entre R\$3,00 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,53. Em 2021, o preço deflacionado é de R\$1,08 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,35. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,88%. É a quarta semana consecutiva de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,35, variando entre R\$2,90 e R\$2,00. Este valor é menor do que a média histórica para esta semana, R\$ 3,04, mas é maior que o preço deflacionado de 2021 (R\$1,03) e que o preço de 2022 (R\$2,21). Em relação à semana anterior os preços reduziram -7,84%. Os preços nas ultimas sete semanas caíram em cinco delas.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,78, variando entre R\$3,00 e R\$2,50.
