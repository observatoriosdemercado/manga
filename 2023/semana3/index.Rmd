...
library(lubridate)
last <- as.Date("2023-01-13")
today <- as.Date("2023-01-20")
sem_ano <- 03 #ajustar semanalmente
```
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,97, variando entre R\$1,20 e R\$0,70. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,55. Em 2021, o preço deflacionado é de R\$1,43 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,40. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 1,04%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,82, variando entre R\$0,95 e R\$0,70. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,06, menor que o preço deflacionado de 2021 (R\$2,33) e que o preço de 2022 (R\$1,41). Em relação à semana anterior os preços diminuíram -19,61%.

Sobre os preços de exportação, não se tem dados disponíveis para esta semana.
