...
library(lubridate)
last <- as.Date("2023-02-10")
today <- as.Date("2023-02-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,92, variando entre R\$2,50 e R\$1,60. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,60. Em 2021, o preço deflacionado é de R\$3,22 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,45. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 21,52%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,36, variando entre R\$2,70 e R\$2,10. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,67, menor que o preço deflacionado de 2021 (R\$3,24), mas é mais alto que o preço de 2022 (R\$1,89). Em relação à semana anterior os preços aumentaram 28,96%.
