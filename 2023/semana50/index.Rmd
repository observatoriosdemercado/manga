...
library(lubridate)
last <- as.Date("2023-12-08")
today <- as.Date("2023-12-15")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,16 variando entre R\$3,50 e R\$2,90. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$1,91. Em 2021, o preço deflacionado é de R\$2,16 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,67. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,61%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,85, variando entre R\$3,00 e R\$2,50. Este valor é maior do que a média histórica para esta semana (R\$1,03), do que o preço de 2022 (R\$0,76) e que o preço deflacionado de 2021 (R\$1,25). Em relação à semana anterior os preços aumentaram 28,96%. Em seis semanas foram cinco altas de preços. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,19, variando entre R\$4,50 e R\$4,00, aumento de 4% em relação a semana anterior. A Tommy para os Estados Unidos e Europa teve média de preço de R\$3,28 e R\$3,29, respectivamente, variando entre R\$3,50 e R\$3,00, aumento de 24% e 25% em relação à semana anterior.
