...
library(lubridate)
last <- as.Date("2023-05-12")
today <- as.Date("2023-05-19")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,10 variando entre R\$2,30 e R\$1,90. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,56. Em 2021, o preço deflacionado é de R\$1,20 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,46. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -15,32%. É a quinta semana consecutiva de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,11, variando entre R\$2,40 e R\$1,80. Este valor é menor do que a média histórica para esta semana (R\$ 3,23) e que o preço de 2022 (R\$2,41). Porém, é maior que o preço deflacionado de 2021 (R\$1,26). Em relação à semana anterior os preços reduziram -10,21%. Os preços nas ultimas oito semanas caíram em seis delas.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,63, variando entre R\$2,80 e R\$2,50, redução de -5% em relação à semana anterior. A Tommy para a Europa teve média de R$ 2,36, com variação de R\$2,20 a R\$2,60.
