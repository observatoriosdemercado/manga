...
library(lubridate)
last <- as.Date("2023-06-23")
today <- as.Date("2023-06-30")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,33 variando entre R\$1,50 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,93. Em 2021, o preço deflacionado é de R\$1,01 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 2,13. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,26%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,83, variando entre R\$2,10 e R\$1,50. Este valor é menor do que a média histórica para esta semana (R\$ 2,38) e que o preço de 2022 (R\$2,62). Porém, é maior que o preço deflacionado de 2021 (R\$1,14). Em relação à semana anterior os preços aumentaram 27,97%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$1,83, variando entre R\$2,00 e R\$1,70.
