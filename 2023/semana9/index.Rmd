...
library(lubridate)
last <- as.Date("2023-02-24")
today <- as.Date("2023-03-03")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,42 variando entre R\$3,20 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,02. Em 2021, o preço deflacionado é de R\$3,88 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,33. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,14%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,04, variando entre R\$3,50 e R\$2,50. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,85, maior que o preço deflacionado de 2022 (R\$2,29), mas é mais baixo que o preço de 2021 (R\$3,85). Em relação à semana anterior os preços aumentaram 15,15%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,72, variando entre R\$3,00 e R\$2,40, um aumento de 2% em relação a semana anterior. Para a Tommy para a Europa, o preço médio foi R\$3,10, variando entre R\$3,30 e R\$3,00.
