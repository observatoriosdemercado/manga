...
library(lubridate)
last <- as.Date("2023-10-06")
today <- as.Date("2023-10-13")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,56 variando entre R\$4,00 e R\$3,20. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,49. Em 2021, o preço deflacionado é de R\$0,97 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,18. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -0,84%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,56, variando entre R\$3,00 e R\$2,00. Este valor é maior do que a média histórica para esta semana (R\$1,09), do que o preço de 2022 (R\$1,08) e que o preço deflacionado de 2021 (R\$0,47). Em relação à semana anterior os preços caíram fortemente, -23,81%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,42, variando entre R\$5,20 e R\$4,00, aumento de 17% em relação a semana passada. A Tommy para a Europa teve média de preço de R\$3,75, variando entre R\$4,50 e R\$3,00, aumento de 1% em relação à semana anterior. A Tommy para os Estados Unidos teve média de R\$3,60, variando entre R\$4,50 e R\$3,00.
