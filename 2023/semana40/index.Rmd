...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,59 variando entre R\$4,00 e R\$3,20. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,57. Em 2021, o preço deflacionado é de R\$1,09 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,06. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 24,65%, a quinta alta seguida. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,36, variando entre R\$4,00 e R\$3,10. Este valor é maior do que a média histórica para esta semana (R\$1,05), do que o preço de 2022 (R\$1,04) e que o preço deflacionado de 2021 (R\$0,59). Em relação à semana anterior os preços aumentaram 9,45%, a quinta alta seguida. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,78, variando entre R\$4,00 e R\$3,50, aumento de 13% em relação a semana passada. A Tommy para a Europa teve média de preço de R\$3,70, variando entre R\$3,80 e R\$3,50.
