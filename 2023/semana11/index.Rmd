...
library(lubridate)
last <- as.Date("2023-03-10")
today <- as.Date("2023-03-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,19 variando entre R\$2,70 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$3,16. Em 2021, o preço deflacionado é de R\$4,06 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,41. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -1,79%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,74, variando entre R\$4,20 e R\$3,00. Este valor é mais alto do que a média histórica para esta semana, R\$ 2,83, maior que o preço deflacionado de 2022 (R\$1,59), e que o preço de 2021 (R\$3,56). Em relação à semana anterior os preços aumentaram 17,61%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,75, variando entre R\$2,80 e R\$2,50, um aumento de 4% em relação a semana anterior. Também foi disponibilizada a informação de preço de Tommy para a Europa, R\$ 3,93, variando entre R\$ 4,00 e R\$3,80.
