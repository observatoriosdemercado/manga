...
library(lubridate)
last <- as.Date("2023-09-15")
today <- as.Date("2023-09-22")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,55 variando entre R\$3,00 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,67. Em 2021, o preço deflacionado é de R\$1,02 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,06. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 21,43%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,56, variando entre R\$3,00 e R\$2,20. Este valor é maior do que a média histórica para esta semana (R\$1,52), do que o preço de 2022 (R\$1,23) e que o preço deflacionado de 2021 (R\$1,00). Em relação à semana anterior os preços aumentaram 19,63%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,86, variando entre R\$3,10 e R\$2,60, aumento de 4% em relação a semana passada. A Tommy para os Estados Unidos foi vendida, na média, por R\$2,75, variando entre R\$2,80 e R\$2,60, 4% mais do que na semana anterior.
