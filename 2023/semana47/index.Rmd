...
library(lubridate)
last <- as.Date("2023-11-17")
today <- as.Date("2023-11-24")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,83 variando entre R\$3,20 e R\$2,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,01. Em 2021, o preço deflacionado é de R\$2,30 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,91. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,28%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,75, variando entre R\$2,00 e R\$1,50. Este valor é maior do que a média histórica para esta semana (R\$1,10), do que o preço de 2022 (R\$0,34) e que o preço deflacionado de 2021 (R\$1,11). Em relação à semana anterior os preços aumentaram 15,13%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,97, variando entre R\$4,50 e R\$3,50, aumento de 5% em relação a semana anterior. A Tommy para os Estados Unidos teve média de preço de R\$2,37 (variando entre R\$2,80 e R\$2,00) e para a Europa, R\$2,52 (variando entre R\$2,80 e R\$2,20), aumento de 2% em relação à semana anterior para os Estados Unidos e 19% para a Europa.
