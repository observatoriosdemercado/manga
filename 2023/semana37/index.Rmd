...
library(lubridate)
last <- as.Date("2023-09-08")
today <- as.Date("2023-09-15")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,10 variando entre R\$2,40 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,86. Em 2021, o preço deflacionado é de R\$0,84 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 1,24. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,60%. 

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,14, variando entre R\$2,50 e R\$1,90. Este valor é maior do que a média histórica para esta semana (R\$1,91), do que o preço de 2022 (R\$1,44) e que o preço deflacionado de 2021 (R\$1,50). Em relação à semana anterior os preços aumentaram 11,46%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$2,74, variando entre R\$2,80 e R\$2,20, aumento de 12% em relação a semana passada. A Tommy para os Estados Unidos foi vendida, na média, por R\$2,65, variando entre R\$3,00 e R\$2,40.
