...
library(lubridate)
last <- as.Date("2023-11-10")
today <- as.Date("2023-11-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,74 variando entre R\$3,50 e R\$2,30. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$2,02. Em 2021, o preço deflacionado é de R\$1,90 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,99. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -11,04%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,52, variando entre R\$1,70 e R\$1,30. Este valor é maior do que a média histórica para esta semana (R\$1,22), do que o preço de 2022 (R\$0,53) e que o preço deflacionado de 2021 (R\$1,03). Em relação à semana anterior os preços diminuíram -5,59%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,78, variando entre R\$4,00 e R\$3,50. A Tommy tanto para os Estados Unidos teve média de preço de R\$2,33 e para a Europa, R\$2,11, ambos destinos os preços variando entre R\$3,00 e R\$1,70, redução de -11% em relação à semana anterior para os Estados Unidos e -1% para a Europa.
