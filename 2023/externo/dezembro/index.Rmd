...
today <- as.Date("2023-12-29") #data para o IGPI - ultima semana do preço
mes <- 12
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 27,2 mil toneladas (t) de mangas pelo Brasil. Este valor é menor do que o exportado pelo país, no mesmo mês, em 2021 (27,6 mil t), do que em `r strftime(atual, format = "%B")` de 2022 (41,6 mil t), mas supera a média histórica (2012 a 2020), que é de 17,5 mil t, aproximadamente. No ano, foram exportadas cerca de 266 mil t, um aumento de 15,01% em relação ao mesmo período de 2022. Contudo, ficou 2,37% abaixo do recorde histórico de 2021.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B")` foram US\$ 37,8 milhões. O máximo histórico (até 2020) para este mês é de US\$ 33 milhões. Em `r strftime(atual, format = "%B")` de 2021, foram gerados cerca de US\$ 23,9 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2022, um total de US$ 36,4 milhões. No ano, as receitas são recorde histórico, cerca de US\$ 312 milhões, superando o valor de US\$ 248,7 milhões de 2021.

As exportações se concentraram principalmente na variedade Palmer para a Europa e Tommy para os Estados Unidos e Europa. Em relação aos destinos, em 2023, 45,3\% das mangas foram enviadas para a Holanda, 18,35\% para os Estados Unidos, 17,93\% para a Espanha, 6,06\% para o Reino Unido e 3,95\% para Portugal. Sobre as vias de exportação, 90,3\% foi marítima, 6,71\% aérea e 2,99\% rodoviária. A maior parte das frutas teve origem na Bahia (47,36\%) e em Pernambuco (45,42\%). São Paulo (3,25\%), Rio Grande do Norte (2,54\%) e Ceará (0,79\%) também contribuíram para os resultados obtidos com as exportações de manga.
