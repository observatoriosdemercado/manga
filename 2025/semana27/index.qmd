...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,53, variando entre R\$4,50 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,04. Em 2023, o preço deflacionado é de R\$1,56 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,82. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -19,41%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,23, variando entre R\$3,00 e R\$1,70. Este valor é menor do que a média histórica para esta semana (R\$2,80), mais alto do que o preço em 2023, R\$ 2,03, mas é menor também do que o valor de 2024 (R\$5,56). Em relação à semana anterior, os preços tiveram baixa de -34,80%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 4,59, variando entre R\$5,10 e R\$4,00, queda de -11% em relação à semana anterior. A **Tommy exportação para a Europa** teve média de R\$3,15, variando entre R\$3,80 e R\$2,50, redução de -19% em relação a semana passada.  
