...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,21, variando entre R\$ 2,90 e R\$ 1,90. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,71. Em 2023, o preço deflacionado é de R\$ 2,10 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,36. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 22,78%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 3,15, variando entre R\$ 3,50 e R\$ 2,90. Este valor é maior do que a média histórica para esta semana (R\$ 2,20), maior do que o preço em 2023, R\$ 2,05, e do que o valor de 2024 (R\$ 2,91). Em relação à semana anterior, os preços tiveram alta de 19,77%. 

Sobre os preços de exportação, a **Keitt Exportação** teve média de R\$ 2,48, variando entre R\$ 2,90 e R\$ 2,00, aumento de 24% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 4,03, variando entre R\$ 4,40 e R\$ 3,50
