...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,55, variando entre R\$2,00 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,93. Em 2023, o preço deflacionado é de R\$2,41 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,88. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,64%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,14, variando entre R\$2,50 e R\$1,65. Este valor é menor do que a média histórica para esta semana (R\$2,50), menor do que o preço em 2023, R\$ 3,31, e do que o valor de 2024 (R\$4,69). Em relação à semana anterior, os preços tiveram alta de 25,15%. 

Sobre os preços de exportação, a **Kent exportação** foi vendida na média por R\$ 3,58, variando entre R\$4,10 e R\$3,00. Para as demais variedades, o mercado não está existindo pois os exportadores possuem fruta própria.
