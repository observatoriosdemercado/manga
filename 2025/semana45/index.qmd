...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,23, variando entre R\$ 2,50 e R\$ 1,90. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,04. Em 2023, o preço deflacionado é de R\$ 3,27 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,51. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,86, variando entre R\$ 2,30 e R\$ 1,50. Este valor é maior do que a média histórica para esta semana (R\$ 1,34), maior do que o preço em 2023, R\$ 1,71 e do que o valor de 2024 (R\$ 0,65). Em relação à semana anterior, os preços tiveram reduziram -9,71%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,96, variando entre R\$ 3,50 e R\$ 2,60, aumento de 5% em relação à semana anterior. A média de preço da **Tommy Exportação para os Estados Unidos** foi R\$2,17, variando entre R\$2,30 e R\$2,00, queda de -3% em relação à semana passada. A **Keitt Exportação** teve média de R\$ 2,95, variando entre R\$ 3,10 e R\$ 2,70, um aumento de 4% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 2,71, variando entre R\$ 3,10 e R\$ 2,20, uma queda de -23% na semana, a segunda queda expressiva consecutiva.
