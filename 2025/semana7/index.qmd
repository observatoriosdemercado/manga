...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,21, variando entre R\$1,40 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,73. Em 2023, o preço deflacionado é de R\$1,98 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,97. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 24,74%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,90, variando entre R\$3,20 e R\$2,30. Este valor é menor do que a média histórica para esta semana (R\$2,73), que o preço de 2023 (R\$2,44) e do que o preço deflacionado de 2024 (R\$3,44). Em relação à semana anterior, os preços tiveram crescimento de 92%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,04, variando entre R\$2,30 e R\$1,70, um aumento de 3% em relação à semana anterior.
