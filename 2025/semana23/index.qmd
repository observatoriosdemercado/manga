...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,69, variando entre R\$5,00 e R\$4,30. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,14. Em 2023, o preço deflacionado é de R\$1,46 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 5,12. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,82%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,63, variando entre R\$6,30 e R\$5,25. Este valor é maior do que máxímo histórico para esta semana (R\$5,61), obtido em 2024. O preço em 2023 foi R\$ 1,88 e a média histórica é (R\$2,96). Em relação à semana anterior, os preços tiveram alta de 7,44%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 5,19, variando entre R\$5,60 e R\$4,80, um aumento de 18% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$5,72, variando entre R\$6,05 e R\$5,50, um aumento de 1% na comparação com a semana passada. 
