...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,49, variando entre R\$1,60 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,77. Em 2023, o preço deflacionado é de R\$2,15 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,52. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -2,61%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,23, variando entre R\$2,60 e R\$1,80. Este valor é menor do que a média histórica para esta semana (R\$2,51), menor do que o preço em 2024, R\$ 4,27, mas é maior do que o valor de 2023 (R\$1,99). Em relação à semana anterior, os preços tiveram alta de 23,89%. 

Sobre os preços de exportação, a **Palmer Exportação** foi vendida na média por R\$ 2,17, variando entre R\$2,50 e R\$2,00, alta de 12% em relação a semana anterior. A **Keitt Exportação** teve média de R\$2,03, variando entre R\$2,35 e R$ 1,80, alta de 20% em relação ao preço da semana passada.
