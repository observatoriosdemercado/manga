...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,27, variando entre R\$3,70 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,43. Em 2023, o preço deflacionado é de R\$2,27 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,63. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,48%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,20, variando entre R\$5,00 e R\$3,30. Este valor é maior do que média histórica para esta semana (R\$3,26). O preço em 2023 foi R\$ 2,28 e o preço deflacionado de 2024 (R\$5,50). Em relação à semana anterior, os preços tiveram alta de 15,7%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,79, variando entre R\$4,00 e R\$3,55, um aumento de 13% em relação à semana anterior. 
