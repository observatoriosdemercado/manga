...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,44, variando entre R\$2,30 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,90. Em 2023, o preço deflacionado é de R\$2,19 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,19. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 5,88%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,71, variando entre R\$2,30 e R\$1,10. Este valor é menor do que a média histórica para esta semana (R\$2,27), menor do que o preço em 2023, R\$ 2,80, e do que o valor de 2024 (R\$3,64). Em relação à semana anterior, os preços tiveram alta de 67,65%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,10, variando entre R\$3,00 e R\$1,50, queda de -3% em relação à semana anterior. 
