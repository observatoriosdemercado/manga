...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,97, variando entre R\$1,20 e R\$0,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,58. Em 2023, o preço deflacionado é de R\$1,63 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,86. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 15,48%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,51, variando entre R\$1,80 e R\$1,20. Este valor é menor do que a média histórica para esta semana (R\$2,33), que o preço de 2023 (R\$1,89) e do que o preço deflacionado de 2024 (R\$2,94). Em relação à semana anterior, os preços tiveram crescimento de 42,45%.

Sobre os preços de exportação, a **Tommy para a Europa** foi vendida, na média, por R\$2,15, variando entre R\$2,30 e R\$2,00, um aumento de 30% em relação à semana passada. A **Palmer exportação** foi vendida na média por R\$ 1,98, variando entre R\$2,10 e R\$1,80.
