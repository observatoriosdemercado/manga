...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,50, variando entre R\$2,00 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,39. Em 2023, o preço deflacionado é de R\$0,99 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,23. Em relação à semana `r strftime(last, format = "%V")`, os preços subiram 45,63%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,91, variando entre R\$2,50 e R\$1,40. Este valor é menor do que a média histórica para esta semana (R\$2,07), que o preço de 2024 (R\$3,83), mas é maior do que o preço deflacionado de 2023 (R\$1,05). Em relação à semana anterior, os preços subiram 43,61%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$1,95, variando entre R\$2,50 e R\$1,50, ou seja, um aumento de 33% em relação a semana anterior. O mercado reabriu para a **Tommy para a Europa**, que teve média de R\$2,00 na semana, variando entre R\$2,50 e R\$1,50.
