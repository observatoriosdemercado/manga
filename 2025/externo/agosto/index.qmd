...
library(lubridate)
anterior <- as.Date("2025-07-01")
atual <-  as.Date("2025-08-01") #ultimo mes disponibilizado
today <- as.Date("2025-08-29") #data para o IGPI - ultima semana do preço
mes <- 8
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 19,7 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (14,9 mil t). Nos primeiros oito meses do ano, foram exportadas cerca de 131,7 mil t, volume aproximadamente 18,3% mais elevado do que no mesmo período de 2024. Em relação ao mesmo mês do ano passado, se tem estabilidade.

Em relação ao mercado norte americano, no ano foram exportadas 3,47 mil t. Em 2024, no mesmo período, foram 2,99 mil t. Considerando apenas o mes de agosto, em 2025 foram exportadas 2,92 mil t de mangas, um aumento de 92,4% na comparação com 2024, onde foram exportadas 1,52 mil t. 

As exportações se concentraram nas variedades Palmer, Kent e Keitt para a Europa e Tommy Atkins para os Estados Unidos. Em relação aos principais destinos, no ano, 52,2% das mangas foram enviadas para a Holanda, 23,27% para a Espanha e 7,09% para Portugal. A Argentina (2,36%) e o Chile (2,11%) crescem nas estatísticas de exportações de manga. 

A principal via de envio foi a marítima (85,04%), com 81,89% do total despachado pela alfândega de Fortaleza e 6,48% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (57,24%) e na Bahia (33,53%). Os estados de São Paulo (4,5%) e Rio Grande do Norte (2,47%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2025 é de R$5,57 para 1 dólar.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "Aeroporto de GRU", "ALF-Foz do Iguaçu", "ALF-Dionísio Cerqueira", "Aeroporto de VCP",  "IRF Natal", "ALF-Salvador", "ALF-Belo Horizonte", "Outros"))
