...
library(lubridate)
anterior <- as.Date("2025-09-01")
atual <-  as.Date("2025-10-01") #ultimo mes disponibilizado
today <- as.Date("2025-10-31") #data para o IGPI - ultima semana do preço
mes <- 10
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 47,3 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (35,4 mil t). Nos dez meses do ano, foram exportadas cerca de 218,5 mil t, volume aproximadamente 14,5% mais elevado do que no mesmo período de 2024. Em relação ao mesmo mê do ano passado, se tem uma diminuição de -4,79%.

Em relação ao mercado norte americano, no ano foram exportadas 32,4 mil t. Em 2024, no mesmo período, foram 23,8 mil t. Considerando apenas o mes de outubro, em 2025 foram exportadas 15 mil t de mangas, um aumento de 33,57% na comparação com 2024, onde foram exportadas 11,3 mil t. 

As exportações se concentraram nas variedades Palmer, Kent e Keitt para a Europa e Tommy Atkins para os Estados Unidos. Em relação aos principais destinos, no ano, 49,31% das mangas foram enviadas para a Holanda, 18,4% para a Espanha e 10,13% para os Estados Unidos.

A principal via de envio foi a marítima (87,32%), com 80,71% do total despachado pela alfândega de Fortaleza e 5,64% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (51,58%) e na Bahia (40,84%). Os estados de São Paulo (3,62%) e Rio Grande do Norte (2,35%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2025 é de R$5,43 para 1 dólar.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "Aeroporto de GRU", "ALF-Salvador", "IRF Natal", "ALF-Foz do Iguaçu" , "ALF-Dionísio Cerqueira", "Aeroporto de VCP", "ALF-Belo Horizonte", "Outros"))
