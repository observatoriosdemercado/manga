...
library(lubridate)
anterior <- as.Date("2025-08-01")
atual <-  as.Date("2025-09-01") #ultimo mes disponibilizado
today <- as.Date("2025-10-03") #data para o IGPI - ultima semana do preço
mes <- 9
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 39,4 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (27,6 mil t). Nos nove meses do ano, foram exportadas cerca de 171,1 mil t, volume aproximadamente 21,3% mais elevado do que no mesmo período de 2024. Em relação ao mesmo mês do ano passado, se tem um aumento de 32,8%.

Em relação ao mercado norte americano, no ano foram exportadas 17,3 mil t. Em 2024, no mesmo período, foram 12,8 mil t. Considerando apenas o mes de setembro, em 2025 foram exportadas 13,8 mil t de mangas, um aumento de 41,36% na comparação com 2024, onde foram exportadas 9,8 mil t. 
...
A principal via de envio foi a marítima (86,47%), com 81,68% do total despachado pela alfândega de Fortaleza e 5,99% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (54,63%) e na Bahia (37,34%). Os estados de São Paulo (3,95%) e Rio Grande do Norte (2,28%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2025 é de R$5,46 para 1 dólar.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "Aeroporto de GRU", "ALF-Salvador", "ALF-Foz do Iguaçu", "IRF Natal", "ALF-Dionísio Cerqueira", "Aeroporto de VCP", "ALF-Belo Horizonte", "Outros"))
