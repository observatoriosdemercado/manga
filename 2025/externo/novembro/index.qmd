...
library(lubridate)
anterior <- as.Date("2025-10-01")
atual <-  as.Date("2025-11-01") #ultimo mes disponibilizado
today <- as.Date("2025-12-05") #data para o IGPI - ultima semana do preço
mes <- 11
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 41,9 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (33,3 mil t). Nos onze meses do ano, foram exportadas cerca de 260,4 mil t, volume aproximadamente 13,5% mais elevado do que no mesmo período de 2024. Em relação ao mesmo mês do ano passado, se tem um aumento de 8,27%.

Em relação ao mercado norte americano, no ano foram exportadas 36,9 mil t. Em 2024, no mesmo período, foram 32,3 mil t. Considerando apenas o mes de novembro, em 2025 foram exportadas 4,4 mil t de mangas, uma redução de 47,77% na comparação com 2024, onde foram exportadas 8,52 mil t. 

As exportações se concentraram nas variedades Palmer, Kent e Keitt para a Europa e Tommy Atkins para os Estados Unidos. Em relação aos principais destinos, no ano, 48,44% das mangas foram enviadas para a Holanda, 14,9% para a Espanha e 14,15% para os Estados Unidos.

A principal via de envio foi a marítima (88,06%), com 80,19% do total despachado pela alfândega de Fortaleza e 5,31% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (50,78%) e na Bahia (41,69%). Os estados de São Paulo (3,56%) e Rio Grande do Norte (2,37%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2025 é de R$5,40 para 1 dólar.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "Aeroporto de GRU", "IRF Natal", "ALF-Salvador", "ALF-Foz do Iguaçu" , "ALF-Dionísio Cerqueira", "Aeroporto de VCP", "Aeroporto do Rio de Janeiro", "Outros"))
