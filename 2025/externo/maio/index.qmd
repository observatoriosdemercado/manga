...
atual <-  as.Date("2025-05-01") #ultimo mes disponibilizado
today <- as.Date("2025-06-06") #data para o IGPI - ultima semana do preço
mes <- 5
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 9,89 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (8,84 mil t), mas é menor do que os volumes de 2023 (13,4 mil t) e do que o volume de 2024 (11,9 mil t). No ano, foram exportadas 73,6 mil t, praticamente o mesmo montante do mesmo período em 2024, 73,8 mil t.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B")` foram, aproximadamente, US\$ 12,8 milhões. Este valor supera a média histórica (US\$ 10,1 milhões). Porém, é menor do que o valor de 2023 (US\$ 14,1 milhões) e o valor de 2024, US\$ 17,5 milhões. No ano, as receitas chegam a US\$ 80 milhões, redução de -32,7% em relação à 2024.

As exportações se concentraram, principalmente, nas variedades Palmer e Tommy. Em relação aos principais destinos, no ano, 52,21% das mangas foram enviadas para a Holanda, 26,59% para a Espanha e 8,68% para Portugal. 

A principal via de envio foi a marítima (85,25%), com 81,6% do total despachado pela alfândega de Fortaleza e 6,7% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (56,85%) e na Bahia (29,92%). Os estados de São Paulo (5,79%) e Rio Grande do Norte (4,35%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2025 é de R$5,80 para 1 dólar.
