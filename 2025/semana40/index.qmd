...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,51, variando entre R\$ 2,90 e R\$ 2,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,49. Em 2023, o preço deflacionado é de R\$ 3,82 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 1,55. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -19,81%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,17, variando entre R\$ 1,40 e R\$ 0,90. Este valor é menor do que a média histórica para esta semana (R\$ 1,23), menor do que o preço em 2023, R\$ 3,57, mas é maior do que o valor de 2024 (R\$ 0,53). Em relação à semana anterior, os preços tiveram queda de -34,27%. 

Sobre os preços de exportação, a **Keitt Exportação** teve média de R\$ 3,38, variando entre R\$ 3,60 e R\$ 3,25, redução de -11% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 4,40, variando entre R\$ 4,75 e R\$ 4,00, uma diminuição de -7% na semana.
