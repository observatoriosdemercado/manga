...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,22, variando entre R\$ 2,80 e R\$ 1,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 1,84. Em 2023, o preço deflacionado é de R\$ 3,22 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,50. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,74%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,77, variando entre R\$ 2,10 e R\$ 1,50. Este valor é maior do que a média histórica para esta semana (R\$ 1,10), maior do que o preço em 2024, R\$ 0,98, mas é menor do que o valor de 2023 (R\$ 2,33). Em relação à semana anterior, os preços tiveram aumento de 7,27%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,75, variando entre R\$ 3,20 e R\$ 2,30, estável em relação à semana anterior. A média de preço da **Tommy Exportação para os Estados Unidos** foi R\$2,07, variando entre R\$2,20 e R\$2,00, também estável em relação à semana passada. A **Keitt Exportação** teve média de R\$ 3,03, variando entre R\$ 3,10 e R\$ 3,00, aumento de 6% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 3,27, variando entre R\$ 3,50 e R\$ 3,00, aumento de 2% na semana.
