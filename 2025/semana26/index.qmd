...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,38, variando entre R\$4,50 e R\$4,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,90. Em 2023, o preço deflacionado é de R\$1,45 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,54. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -0,45%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,42, variando entre R\$3,90 e R\$3,00. Este valor é maior do que a média histórica para esta semana (R\$2,67), mais alto do que o preço em 2023, R\$ 1,99, mas é menor do que o valor de 2024 (R\$5,67). Em relação à semana anterior, os preços tiveram baixa de -2,84%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 5,18, variando entre R\$5,50 e R\$5,00, queda de -1% em relação à semana anterior. A **Tommy exportação para a Europa** teve média de R\$3,87, variando entre R\$4,00 e R\$3,80, redução de -4% em relação a semana passada.  
