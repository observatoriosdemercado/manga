...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,35, variando entre R\$4,80 e R\$4,05. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,27. Em 2023, o preço deflacionado é de R\$1,44 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 5,35. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 11,54%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,24, variando entre R\$5,60 e R\$5,00. Este valor é maior do que média histórica para esta semana (R\$3,05). O preço em 2023 foi R\$ 1,46 e o preço deflacionado de 2024 (R\$5,31). Em relação à semana anterior, os preços tiveram alta de 6,72%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 4,40, variando entre R\$4,50 e R\$4,20, um aumento de 1% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$5,63, variando entre R\$6,00 e R\$5,40, um aumento de 14% na comparação com a semana passada. 
