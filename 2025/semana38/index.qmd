...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 3,41, variando entre R\$ 4,20 e R\$ 2,90. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,55. Em 2023, o preço deflacionado é de R\$ 2,73 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,39. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 17,18%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 2,04, variando entre R\$ 2,30 e R\$ 1,85. Este valor é maior do que a média histórica para esta semana (R\$ 1,62), menor do que o preço em 2023, R\$ 2,74, mas é maior do que o valor de 2024 (R\$ 1,26). Em relação à semana anterior, os preços tiveram queda de -20%. 

Sobre os preços de exportação, a **Palmer Exportação** foi comercializada na média de R\$ 4,03, variando entre R\$ 4,35 e R\$ 3,70. A **Tommy Exportação para os Estados Unidos** teve preço médio de R\$ 2,95, variando entre R\$ 3,00 e R\$ 2,90. A **Keitt Exportação** teve média de R\$ 3,69, variando entre R\$ 4,20 e R\$ 3,00, aumento de 20% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 4,57, variando entre R\$ 4,75 e R\$ 4,40.
