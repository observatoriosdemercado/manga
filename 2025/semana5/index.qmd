...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,84, variando entre R\$1,10 e R\$0,60. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,50. Em 2023, o preço deflacionado é de R\$1,47 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,52. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -44,37%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,06, variando entre R\$1,30 e R\$0,80. Este valor é menor do que a média histórica para esta semana (R\$2,18), que o preço de 2023 (R\$1,16) e do que o preço deflacionado de 2024 (R\$3,92). Em relação à semana anterior, os preços caíram -34,16%.

Sobre os preços de exportação, a **Tommy para a Europa** foi vendida, na média, por R\$1,65, variando entre R\$1,90 e R\$1,40.
