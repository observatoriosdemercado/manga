...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,53, variando entre R\$1,75 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,88. Em 2023, o preço deflacionado é de R\$2,28 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,81. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -1,29%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,80, variando entre R\$2,10 e R\$1,60. Este valor é menor do que a média histórica para esta semana (R\$2,59), menor do que o preço em 2023, R\$ 2,61, e do que o valor de 2024 (R\$5,03). Em relação à semana anterior, os preços tiveram baixa de -15,89%. 

Sobre os preços de exportação, a **Palmer Exportação** foi vendida na média por R\$ 1,94, variando entre R\$2,50 e R\$1,70. A **Tommy Exportação para os Estados Unidos** foi comercializada por R\$2,15, com mínimo de R\$2,00 e máximo de R\$2,25. A **Keitt Exportação** teve média de R\$1,60, variando entre R\$2,00 e R$ 1,40. A **Kent exportação** foi vendida na média por R\$ 3,36, variando entre R\$4,00 e R\$3,00.
