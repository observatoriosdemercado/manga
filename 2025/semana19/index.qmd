...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,16, variando entre R\$3,80 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,33. Em 2023, o preço deflacionado é de R\$2,68 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,44. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,97%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,63, variando entre R\$4,00 e R\$3,00. Este valor é maior do que média histórica para esta semana (R\$3,02). O preço em 2023 foi R\$ 2,54 e o preço deflacionado de 2024 (R\$4,34). Em relação à semana anterior, os preços tiveram forte alta de 21,4%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,36, variando entre R\$3,70 e R\$3,00, uma queda de -1% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$3,70, variando entre R\$4,20 e R\$2,90, aumento de 11% em relação aos preços da semana anterior. 
