...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,90, variando entre R\$4,80 e R\$3,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,38. Em 2023, o preço deflacionado é de R\$1,62 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 5,01. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 19,27%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,91, variando entre R\$5,50 e R\$4,40. Este valor é maior do que média histórica para esta semana (R\$3,10). O preço em 2023 foi R\$ 1,48 e o preço deflacionado de 2024 (R\$5,51). Em relação à semana anterior, os preços tiveram alta de 16,9%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 4,36, variando entre R\$4,80 e R\$3,95, um aumento de 15% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$4,93, variando entre R\$5,50 e R\$4,20. 
