...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,65, variando entre R\$3,00 e R\$2,40. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,49. Em 2023, o preço deflacionado é de R\$3,19 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,46. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 4,33%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,49, variando entre R\$2,80 e R\$2,30. Este valor é menor do que média histórica para esta semana (R\$2,65). O preço em 2023 foi R\$ 3,14 e o preço deflacionado de 2024 (R\$1,63). Em relação à semana anterior, os preços tiveram aumento de 40,68%. É a primeira alta depois de cinco semanas seguidas com queda de preços.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,09, variando entre R\$3,30 e R\$2,80, uma queda de -4% em relação à semana anterior. 
