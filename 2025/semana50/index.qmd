...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,14, variando entre R\$ 2,50 e R\$ 1,60. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 1,93. Em 2023, o preço deflacionado é de R\$ 3,33 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,48. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,60%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,90, variando entre R\$ 2,20 e R\$ 1,50. Este valor é maior do que a média histórica para esta semana (R\$ 1,25), maior do que o preço em 2024, R\$ 1,31, mas menor do que o valor de 2023 (R\$ 3,01). Em relação à semana anterior, os preços aumentaram 7,34%. 
