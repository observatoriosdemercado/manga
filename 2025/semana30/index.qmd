...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,36, variando entre R\$1,50 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,91. Em 2023, o preço deflacionado é de R\$1,89 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,79. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -37,04%. É a sétima semana consecutiva de queda de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,02, variando entre R\$1,30 e R\$0,80. Este valor é menor do que a média histórica para esta semana (R\$2,26), menor do que o preço em 2023, R\$ 2,26, e do que o valor de 2024 (R\$3,63). Em relação à semana anterior, os preços tiveram baixa de -32%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,16, variando entre R\$2,50 e R\$1,60, queda de -24% em relação à semana anterior. 
