...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,49, variando entre R\$2,70 e R\$2,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,32. Em 2023, o preço deflacionado é de R\$2,24 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,49. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 5,96%. A sétima semana seguida de alta de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,27, variando entre R\$2,70 e R\$2,00. Este valor superou a média histórica para esta semana (R\$2,83). O preço em 2023 foi R\$ 4,19 e o preço deflacionado de 2024 (R\$3,51). Em relação à semana anterior, os preços tiveram queda de -34,77%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,15, variando entre R\$3,50 e R\$2,80, um aumento de 5% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$3,08, variando entre R\$3,50 e R\$2,70. Isto representa uma diminuição de de -27% em relação à semana anterior.
