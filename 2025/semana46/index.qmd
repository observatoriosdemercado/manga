...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,16, variando entre R\$ 2,40 e R\$ 1,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 1,99. Em 2023, o preço deflacionado é de R\$ 2,91 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,51. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,14%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,68, variando entre R\$ 1,95 e R\$ 1,40. Este valor é maior do que a média histórica para esta semana (R\$ 1,22), maior do que o preço em 2023, R\$ 1,61 e do que o valor de 2024 (R\$ 0,91). Em relação à semana anterior, os preços tiveram reduziram -9,68%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,80, variando entre R\$ 3,20 e R\$ 2,50, diminuição de -5% em relação à semana anterior. A média de preço da **Tommy Exportação para os Estados Unidos** foi R\$2,03, variando entre R\$2,10 e R\$2,00, queda de -6% em relação à semana passada. A **Keitt Exportação** teve média de R\$ 2,83, variando entre R\$ 3,00 e R\$ 2,50, redução de -4% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 3,24, variando entre R\$ 3,70 e R\$ 3,00, um aumento de 19% na semana.
