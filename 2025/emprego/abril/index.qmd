...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.610 pessoas. No mesmo mês do ano passado, este valor era de 11.831, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 237 pessoas, ou seja, o total de contratações (917) foi maior do que o total de demissões (680). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (146 em 2024 e 237 em 2025), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 641 são do sexo masculino (69,9%) e 276 do sexo feminino (30,1%). Em relação à idade, 55,51% se concentra abaixo dos 30 anos: 152 pessoas até 21 anos, 133 até 24 anos, 124 ate 27 anos e 100 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (366). Do total de contratados, 39,91% possuem este nível de escolaridade. 

Com relação aos salários pagos, 85,17% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025 mas assinado apenas em 29/03/2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 13.662,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_abril25.csv', header=T, sep=";")
