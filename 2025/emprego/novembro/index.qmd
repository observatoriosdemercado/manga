...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.474 pessoas. No mesmo mês do ano passado, este valor era de 12.726, ou seja, existe um aumento de 5,88% no número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -756 pessoas, ou seja, o total de contratações (588) foi menor melhora no saldo total (-803 em 2024 e -756 em 2025), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 358 são do sexo masculino (60,88%) e 230 do sexo feminino (39,12%). Em relação à idade, 51,19% se concentra abaixo dos 30 anos: 111 pessoas até 21 anos, 66 até 24 anos, 73 ate 27 anos e 51 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (273). Do total de contratados, 46,43% possuem este nível de escolaridade. 

Com relação aos salários pagos, 75,85% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 25.000,00. 
...
#Entrando dados no R
dados1 <- read.csv2('novembro_2025.csv', header=T, sep=";")
...
#Entrando dados no R
dados2 <- read.csv2('estoque_novembro25.csv', header=T, sep=";")
