...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 14.454 pessoas. No mesmo mês do ano passado, este valor era de 13.739, ou seja, existe um aumento de 6,15% no número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 119 pessoas, ou seja, o total de contratações (1.085) foi maior do que o total de demissões (966). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (217 em 2024 e 119 em 2025), com menos pessoas mantendo o emprego. 

Dos contratados no mês, 679 são do sexo masculino (62,58%) e 406 do sexo feminino (37,42%). Em relação à idade, 53,09% se concentra abaixo dos 30 anos: 203 pessoas até 21 anos, 142 até 24 anos, 129 ate 27 anos e 102 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (504). Do total de contratados, 46,45% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 12.281,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_setembro25.csv', header=T, sep=";")
