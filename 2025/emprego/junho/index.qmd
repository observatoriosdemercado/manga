...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.252 pessoas. No mesmo mês do ano passado, este valor era de 11.979, ou seja, existe um aumento de 10,63% no número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 169 pessoas, ou seja, o total de contratações (826) foi maior do que o total de demissões (657). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (167 em 2024 e 169 em 2025), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 550 são do sexo masculino (66,59%) e 276 do sexo feminino (33,41%). Em relação à idade, 52,06% se concentra abaixo dos 30 anos: 133 pessoas até 21 anos, 128 até 24 anos, 104 ate 27 anos e 65 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (361). Do total de contratados, 43,70% possuem este nível de escolaridade. 

Com relação aos salários pagos, 82,57% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 7.800,00. 
...
#Entrando dados no R
dados1 <- read.csv2('junho_2025.csv', header=T, sep=";", dec = ".")
...
#Entrando dados no R
dados2 <- read.csv2('estoque_junho25.csv', header=T, sep=";")
