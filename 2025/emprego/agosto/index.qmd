...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 14.454 pessoas. No mesmo mês do ano passado, este valor era de 13.511, ou seja, existe um aumento de 6,98% no número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 526 pessoas, ou seja, o total de contratações (1.256) foi maior do que o total de demissões (730). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (999 em 2024 e 526 em 2025), com menos pessoas mantendo o emprego. 

Dos contratados no mês, 721 são do sexo masculino (57,4%) e 535 do sexo feminino (42,60%). Em relação à idade, 56,05% se concentra abaixo dos 30 anos: 229 pessoas até 21 anos, 201 até 24 anos, 149 ate 27 anos e 125 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (597). Do total de contratados, 47,53% possuem este nível de escolaridade. 

Com relação aos salários pagos, 86,31% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 15.000,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_agosto25.csv', header=T, sep=";")
