...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.941 pessoas. No mesmo mês do ano passado, este valor era de 12.511, ou seja, existe um aumento de 11,43% no número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 673 pessoas, ou seja, o total de contratações (1.521) foi maior do que o total de demissões (848). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (523 em 2024 e 673 em 2025), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 924 são do sexo masculino (60,75%) e 597 do sexo feminino (39,25%). Em relação à idade, 50,09% se concentra abaixo dos 30 anos: 254 pessoas até 21 anos, 209 até 24 anos, 163 ate 27 anos e 136 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (361). Do total de contratados, 41,75% possuem este nível de escolaridade. 

Com relação aos salários pagos, 86,26% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 6.500,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_julho25.csv', header=T, sep=";")
