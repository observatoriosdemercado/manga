...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.410 pessoas. No mesmo mês do ano passado, este valor era de 11.687, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 94 pessoas, ou seja, o total de contratações (916) foi maior do que o total de demissões (822). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (248 em 2024 e 94 em 2025), com menos pessoas mantendo o emprego. 

Dos contratados no mês, 598 são do sexo masculino (65,28%) e 318 do sexo feminino (34,72%). Em relação à idade, 46,83% se concentra abaixo dos 30 anos: 122 pessoas até 21 anos, 120 até 24 anos, 104 ate 27 anos e 83 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (357). Do total de contratados, 38,97% possuem este nível de escolaridade. 

Com relação aos salários pagos, 76,97% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025 mas assinado apenas em 29/03/2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 12.644,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_marco25.csv', header=T, sep=";")
