...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.354 pessoas. No mesmo mês do ano passado, este valor era de 11.423, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 432 pessoas, ou seja, o total de contratações (926) foi maior do que o total de demissões (494). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (247 em 2024 e 432 em 2025), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 551 são do sexo masculino (59,50%) e 375 do sexo feminino (40,50%). Em relação à idade, 53,3% se concentra abaixo dos 30 anos: 182 pessoas até 21 anos, 134 até 24 anos, 102 ate 27 anos e 76 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (434). Do total de contratados, 46,87% possuem este nível de escolaridade. 

Com relação aos salários pagos, 40,06% dos contratados foram pelo valor de R\$ 1.518,00, e  50,86% dos contratados foram pelo valor de R\$ 1.550,00 (valor definido no CCT 2025 mas assinado apenas em 29/03/2025), mais alto que o salário mínimo nacional. O maior salário foi R\$ 12.644,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_fevereiro25.csv', header=T, sep=";")
