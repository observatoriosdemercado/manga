...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,31, variando entre R\$2,70 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,99. Em 2023, o preço deflacionado é de R\$1,62 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,82. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -34,56%. É a quinta semana consecutiva de queda de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,56, variando entre R\$1,90 e R\$1,20. Este valor é menor do que a média histórica para esta semana (R\$2,81), menor do que o preço em 2023, R\$ 2,32, e do que o valor de 2024 (R\$5,45). Em relação à semana anterior, os preços tiveram baixa de -30,04%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,50, variando entre R\$4,00 e R\$3,00, queda de -24% em relação à semana anterior. 
