...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,18, variando entre R\$ 2,50 e R\$ 2,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,02. Em 2023, o preço deflacionado é de R\$ 3,00 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,53. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 0,93%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,60, variando entre R\$ 1,80 e R\$ 1,40. Este valor é maior do que a média histórica para esta semana (R\$ 1,14), maior do que o preço em 2024, R\$ 0,88, mas menor do que o valor de 2023 (R\$ 1,86). Em relação à semana anterior, os preços reduziram -4,76%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,87, variando entre R\$ 3,10 e R\$ 2,50, aumento de 3% em relação à semana anterior. A média de preço da **Tommy Exportação para os Estados Unidos** foi R\$2,07, variando entre R\$2,20 e R\$2,00, mais alto 2% em relação à semana passada. A **Keitt Exportação** teve média de R\$ 3,00, variando entre R\$ 3,20 e R\$ 2,80, alta de 6% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 3,39, variando entre R\$ 4,00 e R\$ 3,00, um aumento de 4% na semana.
