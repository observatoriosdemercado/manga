...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,40, variando entre R\$4,70 e R\$3,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,87. Em 2023, o preço deflacionado é de R\$1,35 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,63. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -2,44%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,52, variando entre R\$4,00 e R\$2,80. Este valor é maior do que a média histórica para esta semana (R\$2,72), mais alto do que o preço em 2023 foi R\$ 1,56, mas é menor do que o valor de 2024 (R\$5,66). Em relação à semana anterior, os preços tiveram baixa de -5,88%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 5,21, variando entre R\$5,50 e R\$5,00, estável em relação à semana anterior. A **Tommy exportação para a Europa** teve média de R\$4,03, variando entre R\$4,10 e R\$4,00.  
