...
# ATUALIZAÇÕES DAS INFORMAÇÕES SOBRE A CULTURA DA MANGA COM DADOS DA PAM/IBGE ATÉ 2024.

<hr>

Os dados utilizados são da Pesquisa Agrícola Municipal (PAM) do IBGE e são anuais relativos ao período de 2011 a 2024.

Em 2024, a área plantada no Brasil foi de aproximadamente 86,5 mil hectares (ha). As duas regiões que concentram a produção nacional são a Nordeste, com aproximadamente 68 mil ha (78,54% do total) e a Sudeste 17,6 mil ha (20,34% do total). Os estados da Bahia (36,8 mil ha); Pernambuco (21,1 mil ha); São Paulo (10,0 mil ha), Minas Gerais (6,5 mil ha), Ceará (4,1 mil ha ) e Rio Grande do Norte (2,7 mil ha) representam, respectivamente, 42,59%, 24,4%, 11,6%, 7,5% e 4,71% e 3,1% do total nacional. O Vale do São Francisco mantém sua trajetória de crescimento de área, saindo de 37,9 mil ha em 2023 para 44,4 mil ha em 2024, segundo o IBGE (2025), um aumento de 17,2%. A cidade de Juazeiro/BA é a que possui a maior área plantada de manga no país, com 13,7 mil ha.

Em termos de volumes, em 2024, o Brasil colheu cerca de 1,84 milhões de toneladas (t), com o Nordeste participando com aproximadamente 82% de todo este volume e o Vale do São Francisco, sozinho, representando 67,5% do total nacional. As quatro cidades com maiores volumes de produção são, respectivamente, Juazeiro (BA) com 417,5 mil t, Petrolina (PE) com 282 mil t, Casa Nova (BA) com 196 mil t e Belém do São Francisco (PE) com 179 mil t. Os volumes somados representam quase 71% de toda a produção do Nordeste. O Vale do São Francisco ultrapassou a marca de 1,24 milhões toneladas, um crescimento de 7,15% em relação ao volume de 2023.

Sobre a produtividade, a média, em 2024, da região Nordeste (21,9 t/ha) é maior do que a média nacional (20,7 t/ha). Segundo o IBGE, o estado de Pernambuco possui a maior produtividade média (27,8 t/ha), seguido da Bahia (22,9 t/ha) e São Paulo (21,2 t/ha). A cidade de Sento S
e (BA) tem a maior produtividade nacional (30,9 t/ha). O Vale do São Francisco possui uma produtividade superior a média regional, cerca de 28 t/ha, na média. No ano de 2011, a produtividade nesta região foi de 21,9 t/ha. Assim, a explicação para o grande crescimento do volume de mangas no Vale do São Francisco tem dois fatores, o crescimento da área e o crescimento da produtividade por área.

A manga gerou quase 3,6 bilhões de reais em valor da produção no Brasil, em 2024, sendo que quase 66% deste total, 2,4 bilhões de reais, teve origem no Vale do Submédio São Francisco.
...
setwd('/Users/jricardofl/Dropbox/tempecon/dados_manga/2025')
...
#Entrando dados no R
setwd('/Users/jricardofl/Dropbox/tempecon/dados_manga/2025')
dados3 <- read_excel("quanti_cidades.xlsx", col_names = TRUE, skip = 3, 
...
dados3 <- dados3 |>
  na.exclude() |>
  arrange(desc(`2024`)) # Exclude cities from Rio Grande do Sul (RS)
...
dados2 <- na.exclude(dados2)
dados2 <- arrange(dados2, desc(dados2$"2024"))
dados2$estados[8] <- "Rio G. do Norte"
dados2 <- dados2[c(1,3,4,8,10,12),]
...
dados1 <- read_excel("valor_regioes.xlsx", col_names = TRUE, skip = 4, col_types = c('text', rep("numeric", 14)), na = "-")
