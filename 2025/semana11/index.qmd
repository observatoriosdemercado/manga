...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,35, variando entre R\$3,00 e R\$1,80. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,16. Em 2023, o preço deflacionado é de R\$2,27 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,45. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,80%. A sexta semana seguida de alta de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,48, variando entre R\$4,10 e R\$2,80. Este valor superou a média histórica para esta semana (R\$3,09). O preço em 2023 foi R\$ 3,87 e o preço deflacionado de 2024 (R\$4,32). Em relação à semana anterior, os preços tiveram queda de -22,15%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,00, variando entre R\$3,50 e R\$2,30, um aumento de 3% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$4,20, variando entre R\$4,30 e R\$4,00.
