...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,51, variando entre R\$2,00 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,52. Em 2023, o preço deflacionado é de R\$1,11 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 5,00. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -12,72%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,61, variando entre R\$1,90 e R\$1,30. Este valor é menor do que a média histórica para esta semana (R\$2,13), que o preço de 2024 (R\$4,67), mas é maior do que o preço deflacionado de 2023 (R\$0,74). Em relação à semana anterior, os preços caíram -23,22%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$2,23, variando entre R\$2,50 e R\$2,00.
