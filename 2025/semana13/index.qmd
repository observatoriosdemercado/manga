...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,42, variando entre R\$2,80 e R\$1,70. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,42. Em 2023, o preço deflacionado é de R\$2,42 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,86. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -2,81%. A primeira redução depois de sete semanas seguidas de alta de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,93, variando entre R\$2,10 e R\$1,70. Este valor é menor do que média histórica para esta semana (R\$2,70). O preço em 2023 foi R\$ 3,40 e o preço deflacionado de 2024 (R\$2,97). Em relação à semana anterior, os preços tiveram queda de -14,98%. É a quarta semana seguida com queda de preços.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,12, variando entre R\$3,50 e R\$2,80, uma diminuição de -1% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,60, variando entre R\$3,00 e R\$2,20. Isto representa uma redução de de -16% em relação à semana anterior.
