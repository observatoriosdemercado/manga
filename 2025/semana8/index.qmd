...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,57, variando entre R\$2,00 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,97. Em 2023, o preço deflacionado é de R\$2,36 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,64. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 29,75%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,49, variando entre R\$5,00 e R\$3,20. Este valor superou a máxima histórica para esta semana (R\$3,85). O preço em 2023 foi R\$ 2,73 e o preço deflacionado de 2024 (R\$3,40). Em relação à semana anterior, os preços tiveram crescimento de 55,83%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,49, variando entre R\$3,00 e R\$2,00, um aumento de 22% em relação à semana anterior.
