...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,90, variando entre R\$3,40 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,13. Em 2023, o preço deflacionado é de R\$2,78 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,58. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 2,11%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,99, variando entre R\$3,20 e R\$2,70. Este valor é maior do que média histórica para esta semana (R\$2,72). O preço em 2023 foi R\$ 2,75 e o preço deflacionado de 2024 (R\$3,36). Em relação à semana anterior, os preços tiveram estabilidade. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,39, variando entre R\$3,80 e R\$3,00, uma alta de 2% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$3,33, variando entre R\$3,50 e R\$3,20, aumento de 3% em relação aos preços da semana anterior. 
