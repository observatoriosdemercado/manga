...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,80, variando entre R\$2,50 e R\$1,45. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,65. Em 2023, o preço deflacionado é de R\$2,04 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,43. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 20,81%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,63, variando entre R\$3,00 e R\$2,30. Este valor é maior do que a média histórica para esta semana (R\$2,27), maior do que o preço em 2023, R\$ 1,98, mas é menor do que o valor de 2024 (R\$3,64). Em relação à semana anterior, os preços tiveram alta de 17,94%. 

Sobre os preços de exportação, a **Palmer Exportação** foi vendida na média por R\$ 2,01, variando entre R\$2,20 e R\$1,75, baixa de -7% em relação a semana anterior. A **Keitt Exportação** teve média de R\$2,00, variando entre R\$2,10 e R$ 1,90, queda de -1% em relação ao preço da semana passada.
