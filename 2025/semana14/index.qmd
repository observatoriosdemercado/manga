...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,54, variando entre R\$2,80 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,49. Em 2023, o preço deflacionado é de R\$2,99 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,67. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 4,96%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,77, variando entre R\$2,00 e R\$1,50. Este valor é menor do que média histórica para esta semana (R\$2,67). O preço em 2023 foi R\$ 2,94 e o preço deflacionado de 2024 (R\$2,18). Em relação à semana anterior, os preços tiveram queda de -8,29%. É a quinta semana seguida com queda de preços.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,23, variando entre R\$3,88 e R\$2,80, um aumento de 3% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,20, variando entre R\$2,70 e R\$2,00. Isto representa uma redução de de -15% em relação à semana anterior.
