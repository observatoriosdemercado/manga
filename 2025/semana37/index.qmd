...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,91, variando entre R\$ 3,50 e R\$ 2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,66. Em 2023, o preço deflacionado é de R\$ 2,24 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,52. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 31,67%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 2,55, variando entre R\$ 3,10 e R\$ 2,00. Este valor é maior do que a média histórica para esta semana (R\$ 1,97), maior do que o preço em 2023, R\$ 2,29, e do que o valor de 2024 (R\$ 1,62). Em relação à semana anterior, os preços tiveram queda de -19,05%. 

Sobre os preços de exportação, a **Palmer Exportação** foi comercializada na média de R\$ 3,41. A **Keitt Exportação** teve média de R\$ 3,17, variando entre R\$ 3,80 e R\$ 2,50, aumento de 28% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 4,57, variando entre R\$ 4,80 e R\$ 4,50, uma alta de 13% em relação a última semana.
