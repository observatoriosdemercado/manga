...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,16, variando entre R\$2,80 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,09. Em 2023, o preço deflacionado é de R\$2,29 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 3,71. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 21,35%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,47, variando entre R\$5,00 e R\$3,80. Este valor superou a máxima histórica para esta semana (R\$4,26). O preço em 2023 foi R\$ 3,26 e o preço deflacionado de 2024 (R\$4,19). Em relação à semana anterior, os preços tiveram queda de -8,96%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,91, variando entre R\$3,00 e R\$2,80, um aumento de 17% em relação à semana anterior. 
