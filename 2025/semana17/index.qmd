...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,84, variando entre R\$3,30 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,23. Em 2023, o preço deflacionado é de R\$2,85 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,17. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,77%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,99, variando entre R\$3,50 e R\$2,70. Este valor é maior do que média histórica para esta semana (R\$2,75). O preço em 2023 foi R\$ 2,79 e o preço deflacionado de 2024 (R\$2,77). Em relação à semana anterior, os preços tiveram aumento de 9,52%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,32, variando entre R\$3,50 e R\$3,00, uma alta de 3% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$3,22, variando entre R\$3,30 e R\$3,10. 
