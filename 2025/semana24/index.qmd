...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,51, variando entre R\$5,10 e R\$3,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,09. Em 2023, o preço deflacionado é de R\$1,45 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,98. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -3,84%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,74, variando entre R\$4,50 e R\$3,50. Este valor é maior do que a média histórica para esta semana (R\$2,97), mais altod do que o preço em 2023 foi R\$ 1,79, mas é menor do que o valor de 2024 (R\$5,38). Em relação à semana anterior, os preços tiveram forte baixa de -33,57%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 5,20, variando entre R\$5,50 e R\$4,90, estável em relação à semana anterior. 
