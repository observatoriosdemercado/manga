...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,22, variando entre R\$ 2,50 e R\$ 1,90. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,40. Em 2023, o preço deflacionado é de R\$ 3,55 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 1,26. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,74%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,95, variando entre R\$ 2,40 e R\$ 1,50. Este valor é maior do que a média histórica para esta semana (R\$ 1,26), maior do que o preço em 2024, R\$ 0,82, mas é um pouco menor do que o valor de 2023 (R\$ 1,97). Em relação à semana anterior, os preços tiveram aumento forte de 54,76%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,65, variando entre R\$ 2,80 e R\$ 2,50, queda de -12% em relação à semana anterior. A **Keitt Exportação** teve média de R\$ 3,13, variando entre R\$ 3,20 e R\$ 3,05, uma redução de -8% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 3,87, variando entre R\$ 4,40 e R\$ 3,50, uma diminuição de -7% na semana.
