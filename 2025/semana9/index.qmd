...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,78, variando entre R\$2,50 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$3,05. Em 2023, o preço deflacionado é de R\$2,48 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 4,28. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 13,38%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,91, variando entre R\$5,50 e R\$4,50. Este valor superou a máxima histórica para esta semana (R\$3,97). O preço em 2023 foi R\$ 3,12 e o preço deflacionado de 2024 (R\$3,97). Em relação à semana anterior, os preços tiveram crescimento de 9,35%.

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,50, variando entre R\$3,00 e R\$2,00, um aumento de 1% em relação à semana anterior. A **Tommy Exportação para a Europa** foi comercializada por R\$ 4,95, variando entre R\$ 5,00 e R\$ 4,80. 
