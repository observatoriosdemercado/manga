...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,30, variando entre R\$ 2,50 e R\$ 2,10. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 1,95. Em 2023, o preço deflacionado é de R\$ 3,09 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 0,70. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -2,13%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 2,06, variando entre R\$ 2,35 e R\$ 1,65. Este valor é maior do que a média histórica para esta semana (R\$ 1,33), maior do que o preço em 2023, R\$ 1,69 e do que o valor de 2024 (R\$ 0,48). Em relação à semana anterior, os preços tiveram aumentaram 9,57%. 

Sobre os preços de exportação, a **Palmer Exportação** teve média de R\$ 2,82, variando entre R\$ 3,10 e R\$ 2,50, diminuição de -3% em relação à semana anterior. A média de preço da **Tommy Exportação para os Estados Unidos** foi R\$2,23, variando entre R\$2,40 e R\$2,00, aumento de 9% em relação à semana passada. A **Keitt Exportação** teve média de R\$ 2,84, variando entre R\$ 3,10 e R\$ 2,50, uma redução de -5% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 3,54, variando entre R\$ 4,50 e R\$ 3,00, uma queda de -12% na semana.
