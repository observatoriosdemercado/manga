...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 3,13, variando entre R\$ 3,80 e R\$ 2,50. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$ 2,57. Em 2023, o preço deflacionado é de R\$ 3,08 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 2,29. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -8,21%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,78, variando entre R\$ 2,00 e R\$ 1,50. Este valor é maior do que a média histórica para esta semana (R\$ 1,37), maior do que o preço em 2024, R\$ 0,98, mas é maior do que o valor de 2023 (R\$ 3,28). Em relação à semana anterior, os preços tiveram queda de -12,75%. 

Sobre os preços de exportação, a **Palmer Exportação** foi comercializada na média de R\$ 3,64, variando entre R\$ 3,80 e R\$ 2,50, queda de -9% em relação a semana anterior. A **Tommy Exportação para os Estados Unidos** teve preço médio de R\$ 2,02, variando entre R\$ 2,30 e R\$ 1,70, redução de -32% na comparação com a semana passada. A **Keitt Exportação** teve média de R\$ 3,81, variando entre R\$ 4,55 e R\$ 3,20, aumento de 3% em relação ao preço da semana passada. No caso da **Kent Exportação**, a média da semana foi R\$ 4,75, variando entre R\$ 5,00 e R\$ 4,50, um crescimento de 4% na semana.
