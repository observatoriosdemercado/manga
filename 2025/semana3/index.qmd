...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,73, variando entre R\$2,00 e R\$1,30. A média histórica dos dados deflacionados, desde 2012 até 2024, para esta semana, é R\$2,51. Em 2023, o preço deflacionado é de R\$1,00 para a semana `r strftime(today, format = "%V")` e, em 2024, o preço é R\$ 5,00. Em relação à semana `r strftime(last, format = "%V")`, os preços subiram 15,33%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,10, variando entre R\$2,40 e R\$1,90. Este valor é menor do que a média histórica para esta semana (R\$2,17), que o preço de 2024 (R\$4,41), mas é maior do que o preço deflacionado de 2023 (R\$0,85). Em relação à semana anterior, os preços subiram 9,95%.
