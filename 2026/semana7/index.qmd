...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,47, variando entre R\$ 3,00 e R\$ 2,00. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,59. Em 2024, o preço deflacionado é de R\$ 4,91 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 1,18. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -4,26%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,25, variando entre R\$ 1,40 e R\$ 1,10. Este valor é menor do que a média histórica para esta semana (R\$ 2,71), menor do que o preço em 2024, R\$ 3,40, e do que o valor de 2025 (R\$ 2,84). Em relação à semana anterior, os preços aumentaram 26,26%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,68, variando entre R\$4,00 e R\$3,20, um aumento de 2% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$1,83, variando entre R\$2,00 e R\$1,70, queda de -1% em relação a última semana. 
