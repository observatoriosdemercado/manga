...
# Declara os pacotes Python exigidos pelo chunk de cambio (secao 9) para que
# o reticulate provisione o ambiente efemero (uv) ja com tudo -- sem isso ele
# so detectava "numpy" sozinho e o render quebrava em "No module named 'pandas'".
reticulate::py_require(c("pandas", "numpy", "plotnine", "python-dateutil", "requests"))
...
g8 <- ggplot() +
  geom_col(data=dados21a, aes(x=ordena_outros(URF, value), y=value, fill=variable), size=2, width = 0.7, position = position_dodge(width = .5, preserve = "total"))+
  scale_fill_manual(values=mycolors) +
  ...
  geom_text(data=dados21a, aes(y=value, x=ordena_outros(URF, value), group=variable, label=value),
