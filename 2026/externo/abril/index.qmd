...
atual <-  as.Date("2026-04-01") #ultimo mes disponibilizado
today <- as.Date("2026-05-01") #data para o IGPI - ultima semana do preço
mes <- 4
```
...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 25,6 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que a média histórica (11,4 mil t), mais alto do que os volumes de 2024 (16,3 mil t) e o volume de 2025 (24,1 mil t). No ano, foram exportadas 81,1 mil t, um aumento de 27,3% em relação à 2025.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B")` foram, aproximadamente, US\$ 29 milhões. Este valor supera a média histórica (US\$ 13,4 milhões), o valor de 2025 (US\$ 28,5 milhões), e que o valor de 2024 US\$ 26 milhões.

As exportações se concentraram, principalmente, nas variedades Palmer e Tommy para a Europa. Em relação aos principais destinos, no ano, 51,44% das mangas foram enviadas para a Holanda, 24,85% para a Espanha e 8,86% para o Reino Unido. 

A principal via de envio foi a marítima (88,11%), com 84,33% do total despachado pela alfândega de Fortaleza-CE e 4,84% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (62,09%) e na Bahia (27,74%). Os estados de São Paulo (4,31%) e Rio Grande do Norte (2,98%), também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio continua com a apreciação do Real em relação ao dólar e a taxa esperada pelo mercado para o final do ano de 2026 é de R$5,23 para 1 dólar.
