...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,48 variando entre R\$ 1,70 e R\$ 1,20. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,35.  Em 2024, o preço deflacionado é de R\$ 3,47 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 3,21. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -12,43%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 1,95, variando entre R\$ 2,20 e R\$ 1,70. Este valor é menor do que a média histórica para esta semana (R\$ 3,09), é menor do que o preço em 2024 (R\$ 4,37) e do que o valor de 2025 (R\$ 3,69). Em relação à semana anterior, os preços aumentaram 11,43%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,30, variando entre R\$2,70 e R\$1,90, aumento de 2% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,34, variando entre R\$2,50 e R\$2,10. 
