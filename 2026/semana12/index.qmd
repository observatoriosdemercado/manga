...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,54, variando entre R\$ 2,00 e R\$ 1,40. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,17. Em 2024, o preço deflacionado é de R\$ 3,39 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,43. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -2,53%. É a sétima semana seguida de queda de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,98, variando entre R\$ 2,20 e R\$ 1,80. Este valor é menor do que a média histórica para esta semana (R\$ 2,71), menor do que o preço em 2024, R\$ 3,41, e do que o valor de 2025 (R\$ 2,22). Em relação à semana anterior, os preços aumentaram 8,2%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,19, variando entre R\$2,50 e R\$1,90, estável em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,28, variando entre R\$2,50 e R\$2,00, aumento de 10% na comparação com a última semana. 
