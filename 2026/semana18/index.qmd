...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,69 variando entre R\$ 2,20 e R\$ 1,40. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,08.  Em 2024, o preço deflacionado é de R\$ 2,54 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,85. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -6,6%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 1,75, variando entre R\$ 2,10 e R\$ 1,50. Este valor é menor do que a média histórica para esta semana (R\$ 2,70), é menor do que o preço em 2024 (R\$ 3,31) e do que o valor de 2025 (R\$ 2,94). Em relação à semana anterior, os preços reduziram -3,31%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,26, variando entre R\$2,50 e R\$2,00, estável em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,17, variando entre R\$2,40 e R\$1,80. Na Europa ainda existem os últimos palletes de Kent Peruana e mangas da Costa do Marfim, além da manga brasileira. O Brasil voltou nesta semana a exportar mangas para os Estados Unidos. 
