...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,36, variando entre R\$ 1,80 e R\$ 1,00. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,25. Contudo, a mínima histórica é R$ 1,42, ou seja, no período analisado, nunca se teve um preço tão baixo de manga **Palmer** na semana `r strftime(today, format = "%V")`. Isto ocorre depois de 8 semanas seguidas de queda de preços. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 2,01, variando entre R\$ 2,50 e R\$ 1,80. Este valor é menor do que a média histórica para esta semana (R\$ 2,57), menor do que o preço em 2024 (R\$ 2,88), mas é maior do que o valor de 2025 (R\$ 1,88). Em relação à semana anterior, os preços aumentaram 1,5%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,16, variando entre R\$2,50 e R\$1,90, queda de -1% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,27, variando entre R\$2,30 e R\$2,20, estável na comparação com a última semana. 
