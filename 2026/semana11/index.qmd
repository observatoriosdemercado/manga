...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,58, variando entre R\$ 1,90 e R\$ 1,35. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,01. Em 2024, o preço deflacionado é de R\$ 3,35 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,29. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -4,24%. É a sexta semana seguida de queda de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,83, variando entre R\$ 2,00 e R\$ 1,50. Este valor é menor do que a média histórica para esta semana (R\$ 3,03), menor do que o preço em 2024, R\$ 4,20, e do que o valor de 2025 (R\$ 3,40). Em relação à semana anterior, os preços foram estáveis. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,19, variando entre R\$2,70 e R\$1,70, uma diminuição de -2% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,06, variando entre R\$2,50 e R\$1,70, aumento de 4% na comparação com a última semana. 
