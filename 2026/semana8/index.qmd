...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,24, variando entre R\$ 2,60 e R\$ 1,70. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,84. Em 2024, o preço deflacionado é de R\$ 4,59 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 1,54. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -9,31%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,27, variando entre R\$ 1,50 e R\$ 1,10. Este valor é menor do que a média histórica para esta semana (R\$ 3,04), menor do que o preço em 2024, R\$ 3,37, e do que o valor de 2025 (R\$ 4,40). Em relação à semana anterior, os preços aumentaram 1,6%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,50, variando entre R\$4,00 e R\$3,00, uma diminuição de -5% em relação à semana anterior. 
