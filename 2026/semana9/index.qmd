...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,77, variando entre R\$ 2,20 e R\$ 1,60. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,93. Em 2024, o preço deflacionado é de R\$ 4,23 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 1,74. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -20,98%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,74, variando entre R\$ 2,00 e R\$ 1,50. Este valor é menor do que a média histórica para esta semana (R\$ 3,13), menor do que o preço em 2024, R\$ 3,93, e do que o valor de 2025 (R\$ 4,81). Em relação à semana anterior, os preços aumentaram 37,01%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,75, variando entre R\$3,20 e R\$2,40, uma diminuição de -21% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$1,87, variando entre R\$1,90 e R\$1,80. 
