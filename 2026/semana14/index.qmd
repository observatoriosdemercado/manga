...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,40, variando entre R\$ 1,55 e R\$ 1,20. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,33.  Em 2024, o preço deflacionado é de R\$ 3,57 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,47. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 2,94%. É a primeira vez depois de 8 semanas sequencias de queda de preços.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 2,17, variando entre R\$ 2,60 e R\$ 1,90. Este valor é menor do que a média histórica para esta semana (R\$ 2,53), mas é maior do que o preço em 2024 (R\$ 2,11), e do que o valor de 2025 (R\$ 1,72). Em relação à semana anterior, os preços aumentaram 7,96%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,16, variando entre R\$2,70 e R\$1,90, estáveis em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$2,43, variando entre R\$2,50 e R\$2,30, aumento de 7% na comparação com a última semana. 
