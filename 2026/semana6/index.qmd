...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,58, variando entre R\$ 3,10 e R\$ 2,20. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,44. Em 2024, o preço deflacionado é de R\$ 4,80 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 0,95. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -7,86%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 0,99, variando entre R\$ 1,20 e R\$ 0,80. Este valor é menor do que a média histórica para esta semana (R\$ 2,25), menor do que o preço em 2024, R\$ 2,91, e do que o valor de 2025 (R\$ 1,48). Em relação à semana anterior, os preços reduziram -21,43%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,61, variando entre R\$4,00 e R\$3,30, um aumento de 1% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$1,85, variando entre R\$2,20 e R\$1,50, crescimento de 7% em relação a última semana. 
