...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,81 variando entre R\$ 2,20 e R\$ 1,40. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,16.  Em 2024, o preço deflacionado é de R\$ 2,14 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,79. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -6,7%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 1,81, variando entre R\$ 2,00 e R\$ 1,50. Este valor é menor do que a média histórica para esta semana (R\$ 2,73), é menor do que o preço em 2024 (R\$ 2,73) e do que o valor de 2025 (R\$ 2,94). Em relação à semana anterior, os preços reduziram -27,89%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,47, variando entre R\$2,60 e R\$2,30, estável em relação à semana anterior.  
