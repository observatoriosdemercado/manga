...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,92, variando entre R\$ 2,55 e R\$ 1,60. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 3,39.  Em 2024, o preço deflacionado é de R\$ 3,41 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,61. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 37,14%. Depois de 5 semanas com preços próximos do minímo histórico, eles se afastaram um pouco, mas ainda estão baixos para o período do ano.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")`, os preços médios foram de R\$ 2,79, variando entre R\$ 3,00 e R\$ 2,45. Este valor superou a média histórica para esta semana (R\$ 2,61), é maior do que o preço em 2024 (R\$ 1,61), e do que o valor de 2025 (R\$ 2,45). Em relação à semana anterior, os preços aumentaram 28,57%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,37, variando entre R\$2,80 e R\$2,00, aumento de 10% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$3,00, sem variação, aumento de 23% na comparação com a última semana. 
