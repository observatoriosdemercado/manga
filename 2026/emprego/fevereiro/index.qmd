...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.270 pessoas. No mesmo mês do ano passado, este valor era de 12.354, ou seja, existe um aumento de 7,41% no número de pessoas ocupadas na mangicultura.

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 613 pessoas, ou seja, o total de contratações (1.080) foi maior do que o total de demissões (467).  Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (432 em 2025 e 613 em 2026), com mais pessoas mantendo o emprego. 

Dos contratados no mês, 644 são do sexo masculino (59,63%) e 436 do sexo feminino (40,37%). Em relação à idade, 48,52% se concentra abaixo dos 30 anos: 147 pessoas até 21 anos, 148 até 24 anos, 131 ate 27 anos e 98 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (461). Do total de contratados, 42,69% possuem este nível de escolaridade. 

Com relação aos salários pagos, 90,65% dos contratados foram pelo valor de R\$ 1.621,00, o salário mínimo nacional. O maior salário foi R\$ 8.738,00. 
