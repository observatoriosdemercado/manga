...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.632 pessoas. No mesmo mês do ano passado, este valor era de 11.942, ou seja, existe um aumento de 5,77% no número de pessoas ocupadas na mangicultura.

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -240 pessoas, ou seja, o total de contratações (530) foi menor menor do que o total de demissões (770).   Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (77 em 2025 e -240 em 2026), com mais pessoas perdendo o emprego. 

Dos contratados no mês, 358 são do sexo masculino (64,15%) e 190 do sexo feminino (35,85%). Em relação à idade, 53,02% se concentra abaixo dos 30 anos: 78 pessoas até 21 anos, 79 até 24 anos, 61 ate 27 anos e 63 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (216). Do total de contratados, 40,75% possuem este nível de escolaridade. 

Com relação aos salários pagos, 86,04% dos contratados foram pelo valor de R\$ 1.621,00, o salário mínimo nacional, dado que ainda nao foi finalizado o valor pelo CCT 2026. O maior salário foi R\$ 14.589,00. 
...
#Entrando dados no R
dados1 <- read.csv2('janeiro_2026.csv', header=T, sep=";")
...
#Entrando dados no R
dados2 <- read.csv2('estoque_janeiro26.csv', header=T, sep=";")
