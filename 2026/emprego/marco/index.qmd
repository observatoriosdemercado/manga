...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.301 pessoas. No mesmo mês do ano passado, este valor era de 12.410, ou seja, existe um aumento de 7,18% no número de pessoas ocupadas na mangicultura.

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -8 pessoas, ou seja, o total de contratações (863) foi menor do que o total de demissões (871).  Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (94 em 2025 e -8 em 2026), com menos pessoas mantendo o emprego. 

Dos contratados no mês, 552 são do sexo masculino (63,96%) e 311 do sexo feminino (36,04%). Em relação à idade, 48,2% se concentra abaixo dos 30 anos: 125 pessoas até 21 anos, 122 até 24 anos, 92 ate 27 anos e 77 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (427). Do total de contratados, 49,48% possuem este nível de escolaridade. 

Com relação aos salários pagos, 39,28% dos contratados foram pelo valor de R\$ 1.621,00, o salário mínimo nacional. Além disso, 44,15% foram pelo valor de R\$ 1.664,00, que é o novo piso salarial para a categoria, resultado da 32 CCT da Fruticultura irrigada para o ano de 2026. 
...
#Entrando dados no R
dados1 <- read.csv2('marco_2026.csv', header=T, sep=";")
...
#Entrando dados no R
dados2 <- read.csv2('estoque_marco26.csv', header=T, sep=";")
