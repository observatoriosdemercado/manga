...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 1,65, variando entre R\$ 2,00 e R\$ 1,40. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,96. Em 2024, o preço deflacionado é de R\$ 3,63 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 2,11. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -6,78%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,83, variando entre R\$ 2,00 e R\$ 1,70. Este valor é menor do que a média histórica para esta semana (R\$ 3,19), menor do que o preço em 2024, R\$ 4,11, e do que o valor de 2025 (R\$ 4,36). Em relação à semana anterior, os preços aumentaram 5,17%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 2,24, variando entre R\$2,80 e R\$1,90, uma diminuição de -19% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$1,98, variando entre R\$2,10 e R\$1,80, aumento de 6% na comparação com a última passada. 
