...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$ 2,80, variando entre R\$ 3,10 e R\$ 2,15. A média histórica dos dados deflacionados, desde 2012 até 2025, para esta semana, é R\$ 2,36. Em 2024, o preço deflacionado é de R\$ 4,47 para a semana `r strftime(today, format = "%V")` e, em 2025, o preço é R\$ 0,83. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,87%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$ 1,26, variando entre R\$ 1,60 e R\$ 1,00. Este valor é menor do que a média histórica para esta semana (R\$ 2,08), menor do que o preço em 2024, R\$ 3,87, mas maior do que o valor de 2025 (R\$ 1,05). Em relação à semana anterior, os preços reduziram -9,35%. 

Sobre os preços de exportação, a **Palmer exportação** foi vendida na média por R\$ 3,56, variando entre R\$3,90 e R\$3,30, um aumento de 6% em relação à semana anterior. A **Tommy Exportação para a Europa** teve média de R\$1,73, variando entre R\$2,00 e R\$1,50, queda de 30% em relação a última semana. 
