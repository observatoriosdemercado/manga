...
library(lubridate)
last <- as.Date("2022-09-09")
today <- as.Date("2022-09-16")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$1,32, variando entre R\$1,45 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$3,17. Em 2020, o preço deflacionado é de R\$2,21 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 0,91. Em relação à semana `r strftime(last, format = "%V")`, os preços tiveram uma diminuição de -11,41\%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,53, variando entre R\$1,80 e R\$1,20. Este valor é mais baixo do que a média histórica para esta semana, R\$ 2,03, menor que o preço deflacionado de 2020 (R\$2,28) e que o preço de 2021 (R\$1,61). Em relação à semana anterior os preços tiveram um aumento de 0,66%.

Nos dados de exportação, os preços médios de manga Palmer na semana `r strftime(today, format = "%V de %Y")` foram R\$1,73 variando entre R\$2,00 e R\$1,60. A manga Tommy para os Estados Unidos e para a Europa tiveram a mesma cotação média, R\$1,98, variando entre R\$2,20 e R\$1,80.
