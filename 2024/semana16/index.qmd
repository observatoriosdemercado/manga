...
library(lubridate)
last <- as.Date("2024-04-12")
today <- as.Date("2024-04-19")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,26, variando entre R\$3,00 e R\$1,70. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,17. Em 2022, o preço deflacionado é de R\$1,46 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,71. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -29,60%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,04, variando entre R\$1,30 e R\$0,80. Este valor é menor do que a média histórica para esta semana (R\$2,54), que o preço de 2022 (R\$1,82) e deflacionado de 2023 (R\$2,43). É a terceira vez no ano que a Tommy tem preço menor do que a média da semana. Em relação à semana anterior, os preços diminuíram -31,13%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,03, variando entre R\$3,50 e R\$2,50, redução de -24% em relação a semana anterior. A Tommy para a Europa teve média de R\$1,90, variando entre R\$2,00 e R\$1,70.
