...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,48, variando entre R\$1,80 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,45. Em 2022, o preço deflacionado é de R\$1,24 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,71. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,9%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,62, variando entre R\$0,85 e R\$0,50. Este valor é menor do que a média histórica para esta semana (R\$1,22), que o preço de 2022 (R\$1,13) e que o preço deflacionado de 2023 (R\$2,67). Em relação à semana anterior, os preços aumentaram 16,98%. O primeiro aumento depois de 7 semanas de quedas.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$2,41, variando entre R\$3,00 e R\$1,70, ou seja, um aumento de 16% em relação a semana anterior. A **Kent** foi vendida na média de R\$ 2,51, variando entre R\$3,00 e R\$1,80, redução de -33% em relação ao preço anterior.
