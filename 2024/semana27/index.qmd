...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,64, variando entre R\$4,50 e R\$3,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,80. Em 2022, o preço deflacionado é de R\$2,18 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,47. Em relação à semana `r strftime(last, format = "%V")`, os preços caíram -15,15%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,30, variando entre R\$5,60 e R\$5,00. Este valor é maior do que o máximo histórico para esta semana (R\$4,36), que o preço de 2022 (R\$2,67) e o preço deflacionado de 2023 (R\$1,91). Em relação à semana anterior, os preços caíram -1,12%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,97, variando entre R\$5,70 e R\$4,20, ou seja, uma redução de -4,0% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$5,55, variando entre R\$5,70 e R\$5,00, ou seja, uma queda de -5,0% em relação a semana anterior. No caso da Keitt, o preço médio foi de R\$4,20, com máximo de R\$4,40 e mínimo R\$4,00.
