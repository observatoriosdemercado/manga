...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,29 variando entre R\$4,00 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2020, para esta semana, é R\$1,98. Em 2021, o preço deflacionado é de R\$2,50 para a semana `r strftime(today, format = "%V")` e, em 2022, o preço é R\$ 0,73. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 4,11%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,01, variando entre R\$3,20 e R\$2,80. Este valor é maior do que a média histórica para esta semana (R\$1,30), do que o preço de 2022 (R\$1,25) e que o preço deflacionado de 2021 (R\$1,20). Em relação à semana anterior os preços aumentaram 5,61%. São cinco semanas seguidas de altas de preços. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,16, variando entre R\$4,30 e R\$4,00, queda de -1% em relação a semana anterior. A Tommy para os Estados Unidos e Europa teve média de preço de R\$3,54, respectivamente, variando entre R\$3,60 e R\$3,50, aumento de 8% em relação à semana anterior.
