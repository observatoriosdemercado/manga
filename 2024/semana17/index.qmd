...
library(lubridate)
last <- as.Date("2024-04-19")
today <- as.Date("2024-04-26")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,01, variando entre R\$2,50 e R\$1,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,06. Em 2022, o preço deflacionado é de R\$1,68 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,63. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -11,06%. É a quarta semana seguida de queda de preços de Palmer.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,57, variando entre R\$3,00 e R\$2,20. Este valor é um pouco maior do que a média histórica para esta semana (R\$2,57), que o preço de 2022 (R\$2,12) e igual ao preço deflacionado de 2023 (R\$2,57). Em relação à semana anterior, os preços aumentaram 147,12%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,01, variando entre R\$3,30 e R\$2,80, estável em relação a semana anterior. A Tommy para a Europa teve média de R\$2,55, variando entre R\$3,00 e R\$2,20, aumento de 34% em relação a semana anterior.
