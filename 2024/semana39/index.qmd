...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,25, variando entre R\$2,70 e R\$1,70. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,51. Em 2022, o preço deflacionado é de R\$1,10 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,99. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,85%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,96, variando entre R\$1,20 e R\$0,80. Este valor é menor do que a média histórica para esta semana (R\$1,36), que o preço de 2022 (R\$1,09) e que o preço deflacionado de 2023 (R\$3,19). Em relação à semana anterior, os preços reduziram -22,58%. A sexta semana seguida de queda de preços.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$3,01, variando entre R\$4,00 e R\$2,50, ou seja, um aumento 4% em relação a semana anterior. A **Tommy** tanto para os EUA quanto Europa, teve média de R\$ 1,73 reais, variando entre R\$2,00 e R\$1,40. A **Kent** foi vendida na média de R\$ 4,00, variando entre R\$4,20 e R\$3,80, redução de -6% em relação ao preço anterior.
