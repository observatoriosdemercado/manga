...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,73, variando entre R\$3,50 e R\$2,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,80. Em 2022, o preço deflacionado é de R\$1,69 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,22. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -2,50%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,89, variando entre R\$5,20 e R\$4,50. Este valor é maior do que o máximo histórico para esta semana (R\$3,34), que o preço de 2022 (R\$1,57) e o preço deflacionado de 2023 (R\$2,54). Em relação à semana anterior, os preços aumentaram 7,24%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,18, variando entre R\$5,00 e R\$3,00, ou seja, uma queda de -2% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média de R\$4,92, variando entre R\$5,00 e R\$4,60, ou seja, um aumento de 2,0% em relação a semana anterior. 
...
date <- c(date, as.Date('2024-08-16'))
dadosp$date <- date
