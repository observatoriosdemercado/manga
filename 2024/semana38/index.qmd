...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,34, variando entre R\$2,70 e R\$1,90. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,49. Em 2022, o preço deflacionado é de R\$1,11 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,65. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -5,26%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,24, variando entre R\$1,60 e R\$1,00. Este valor é menor do que a média histórica para esta semana (R\$1,60), que o preço de 2022 (R\$1,28) e que o preço deflacionado de 2023 (R\$2,66). Em relação à semana anterior, os preços reduziram -22,01%. A quinta semana seguida de queda de preços.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$2,89, variando entre R\$3,00 e R\$2,40, ou seja, uma queda de -2% em relação a semana anterior. A **Kent** foi vendida na média de R\$ 4,25, variando entre R\$4,50 e R\$4,00.
