...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,51, variando entre R\$0,70 e R\$0,40. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,15. Em 2022, o preço deflacionado é de R\$1,24 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,25. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -26,09%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,65, variando entre R\$0,80 e R\$0,50. Este valor é menor do que a média histórica para esta semana (R\$1,39), que o preço de 2022 (R\$0,69) e que o preço deflacionado de 2023 (R\$1,70). Em relação à semana anterior, os preços aumentaram 35,42%.

Sobre os preços de exportação, não houveram cotações para nenhuma das variedades.
