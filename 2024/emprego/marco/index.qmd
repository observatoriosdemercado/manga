...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 248 pessoas, ou seja, o total de contratações (955) foi maior do que o total de demissões (707). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (280 em 2023 e 248 em 2024), com menos pessoas conseguindo emprego. 

Dos contratados no mês, 606 são do sexo masculino (63,46%) e 349 do sexo feminino (36,54%). Em relação à idade, 51,83% se concentra abaixo dos 30 anos: 158 pessoas até 21 anos, 124 até 24 anos, 120 ate 27 anos e 93 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (477). Do total de contratados, 49,95% possuem este nível de escolaridade. 

Com relação aos salários pagos, 85,55% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 6.264,00. 
