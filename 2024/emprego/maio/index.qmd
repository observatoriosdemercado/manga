...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -38 pessoas, ou seja, o total de contratações (687) foi menor do que o total de demissões (725). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (71 em 2023 e -38 em 2024), com menos pessoas conseguindo emprego. 

Dos contratados no mês, 473 são do sexo masculino (68,85%) e 214 do sexo feminino (31,15%). Em relação à idade, 51,24% se concentra abaixo dos 30 anos: 98 pessoas até 21 anos, 95 até 24 anos, 91 ate 27 anos e 68 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (324). Do total de contratados, 47,2% possuem este nível de escolaridade. 

Com relação aos salários pagos, 80,06% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 15.298,00. 
...
#Entrando dados no R
dados1 <- read.csv2('maio_2024.csv', header=T, sep=";", dec = ".")
