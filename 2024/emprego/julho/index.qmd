...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.511 pessoas, no mesmo mês do ano passado, este valor era de 12.189, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 523 pessoas, ou seja, o total de contratações (1.278) foi maior do que o total de demissões (755). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (484 em 2023 e 523 em 2024), com mais pessoas conseguindo emprego. 

Dos contratados no mês, 875 são do sexo masculino (68,47%) e 403 do sexo feminino (31,53%). Em relação à idade, 50,7% se concentra abaixo dos 30 anos: 203 pessoas até 21 anos, 168 até 24 anos, 154 ate 27 anos e 123 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (611). Do total de contratados, 47,8% possuem este nível de escolaridade. 

Com relação aos salários pagos, 88,73% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 12.644,00. 
