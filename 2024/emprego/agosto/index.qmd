...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.507 pessoas, no mesmo mês do ano passado, este valor era de 13.416, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 999 pessoas, ou seja, o total de contratações (1.704) foi maior do que o total de demissões (705). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (1.250 em 2023 e 999 em 2024), com menos pessoas conseguindo emprego. 

Dos contratados no mês, 994 são do sexo masculino (58,33%) e 710 do sexo feminino (41,67%). Em relação à idade, 53,23% se concentra abaixo dos 30 anos: 308 pessoas até 21 anos, 258 até 24 anos, 189 ate 27 anos e 152 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (767). Do total de contratados, 45,01% possuem este nível de escolaridade. 

Com relação aos salários pagos, 92,90% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 13.000,00. 
...
totalm <- totalm %>%
  rename("Contratados 2023" = Contratados_Manga.x,
         "Demitidos 2023" = Demitidos_Manga.x,
         "Contratados 2024" = Contratados_Manga.y,
         "Demitidos 2024" = Demitidos_Manga.y,
         "Saldo 2023" = Saldo_Manga.x,
         "Saldo 2024" = Saldo_Manga.y)
...
#Entrando dados no R
dados2 <- read.csv2('estoque_agosto24.csv', header=T, sep=";")
