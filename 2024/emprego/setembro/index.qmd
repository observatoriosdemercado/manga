...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.739 pessoas, no mesmo mês do ano passado, este valor era de 13.878, ou seja, existe uma queda do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 217 pessoas, ou seja, o total de contratações (1.159) foi maior do que o total de demissões (942). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (428 em 2023 e 217 em 2024), com menos pessoas conseguindo emprego. 

Dos contratados no mês, 630 são do sexo masculino (54,36%) e 529 do sexo feminino (45,64%). Em relação à idade, 53,49% se concentra abaixo dos 30 anos: 210 pessoas até 21 anos, 167 até 24 anos, 146 ate 27 anos e 97 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (566). Do total de contratados, 48,84% possuem este nível de escolaridade. 

Com relação aos salários pagos, 84,21% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 11.000,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_setembro24.csv', header=T, sep=";")
