...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 13.527 pessoas, no mesmo mês do ano passado, este valor era de 13.641, ou seja, existe uma queda do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -250 pessoas, ou seja, o total de contratações (887) foi menor do que o total de demissões (1137). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-266 em 2023 e -250 em 2024), com menos pessoas perdendo o emprego. 

Dos contratados no mês, 523 são do sexo masculino (58,96%) e 364 do sexo feminino (41,04%). Em relação à idade, 48,37% se concentra abaixo dos 30 anos: 130 pessoas até 21 anos, 101 até 24 anos, 111 ate 27 anos e 87 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (486). Do total de contratados, 54,79% possuem este nível de escolaridade. 

Com relação aos salários pagos, 86,36% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 12.644,00. 
...
#Entrando dados no R
dados2 <- read.csv2('estoque_outubro24.csv', header=T, sep=";")
