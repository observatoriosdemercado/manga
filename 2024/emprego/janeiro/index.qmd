...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -57 pessoas, ou seja, o total de contratações (541) foi menor do que o total de demissões (598). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-363 em 2023 e -57 em 2024), com menos pessoas perdendo emprego. 

Dos contratados no mês, 356 são do sexo masculino (65,8%) e 185 do sexo feminino (34,2%). Em relação à idade, 51,02% se concentra abaixo dos 30 anos: 90 pessoas até 21 anos, 75 até 24 anos, 68 ate 27 anos e 43 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (243). Do total de contratados, 44,92% possuem este nível de escolaridade. 

Com relação aos salários pagos, 58,78% dos contratados foram pelo valor de R\$ 1.450,00 e 29,02% por R\$ 1.412,00, o salário mínimo nacional. O maior salário foi R\$ 34.248,00. 
