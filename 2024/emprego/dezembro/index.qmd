...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 11.874 pessoas. No mesmo mês do ano passado, este valor era de 11.258, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -834 pessoas, ou seja, o total de contratações (478) foi menor do que o total de demissões (1312). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-1312 em 2023 e -834 em 2024), com menos pessoas perdendo o emprego. 

Dos contratados no mês, 303 são do sexo masculino (63,39%) e 175 do sexo feminino (36,61%). Em relação à idade, 51,46% se concentra abaixo dos 30 anos: 64 pessoas até 21 anos, 67 até 24 anos, 56 ate 27 anos e 59 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (193). Do total de contratados, 40,4% possuem este nível de escolaridade. 

Com relação aos salários pagos, 77,62% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 12.176,00. 
