...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da manga é de 12.726 pessoas, no mesmo mês do ano passado, este valor era de 12.619, ou seja, existe um aumento do número de pessoas ocupadas na mangicultura. 

O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi negativo, de -803 pessoas, ou seja, o total de contratações (494) foi menor do que o total de demissões (1297). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-1038 em 2023 e -803 em 2024), com menos pessoas perdendo o emprego. 

Dos contratados no mês, 301 são do sexo masculino (60,93%) e 193 do sexo feminino (39,07%). Em relação à idade, 52,23% se concentra abaixo dos 30 anos: 79 pessoas até 21 anos, 84 até 24 anos, 55 ate 27 anos e 40 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (247). Do total de contratados, 50% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87,25% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 12.644,00. 
