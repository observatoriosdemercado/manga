...
O saldo de empregos na mangicultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco foi positivo, de 247 pessoas, ou seja, o total de contratações (690) foi maior do que o total de demissões (443). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (65 em 2023 e 247 em 2024), com mais pessoas conseguindo emprego. 

Dos contratados no mês, 472 são do sexo masculino (68,4%) e 218 do sexo feminino (31,6%). Em relação à idade, 54,78% se concentra abaixo dos 30 anos: 127 pessoas até 21 anos, 94 até 24 anos, 82 ate 27 anos e 75 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (321). Do total de contratados, 46,52% possuem este nível de escolaridade. 

Com relação aos salários pagos, 87,39% dos contratados foram pelo valor de R\$ 1.450,00, mais alto que o salário mínimo nacional, valor acordado pela convenção trabalhista. O maior salário foi R\$ 10.292,00. 
