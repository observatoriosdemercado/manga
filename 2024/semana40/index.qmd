...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,54, variando entre R\$1,80 e R\$1,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,49. Em 2022, o preço deflacionado é de R\$1,10 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,71. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -31,56%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,53, variando entre R\$0,65 e R\$0,40. Este valor é menor do que a média histórica para esta semana (R\$1,25), que o preço de 2022 (R\$1,08) e que o preço deflacionado de 2023 (R\$3,47). Em relação à semana anterior, os preços reduziram -44,79%. A sétima semana seguida de queda de preços.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$2,08, variando entre R\$2,50 e R\$1,80, ou seja, uma diminuição -31% em relação a semana anterior. A **Kent** foi vendida na média de R\$ 3,75, variando entre R\$4,50 e R\$3,00, redução de -6% em relação ao preço anterior.
