...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,49, variando entre R\$0,70 e R\$0,30. É a oitava semana seguida de preço abaixo do mínimo histórico. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,06. Em 2022, o preço deflacionado é de R\$0,72 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,35. Em relação à semana `r strftime(last, format = "%V")`, os preços baixaram -3,92%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,33, variando entre R\$1,70 e R\$0,80. Este valor é menor do que a média histórica para esta semana (R\$1,25), que o preço de 2023 (R\$3,02), mas é maior do que o preço deflacionado de 2022 (R\$0,81). Em relação à semana anterior, os preços subiram 34,34%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$0,90, variando entre R\$1,00 e R\$0,80, ou seja, uma queda de -6% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$1,37, variando entre R\$1,50 e R\$1,20, ou seja, um aumento de 24% em relação a semana anterior. 
