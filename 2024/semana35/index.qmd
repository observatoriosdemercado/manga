...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,36, variando entre R\$3,00 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,59. Em 2022, o preço deflacionado é de R\$1,36 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,98. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -3,67%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,54, variando entre R\$4,10 e R\$3,00. Este valor é maior do que o máximo histórico para esta semana (R\$3,16), que o preço de 2022 (R\$1,40) e o preço deflacionado de 2023 (R\$1,93). Em relação à semana anterior, os preços reduziram -14,70%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$3,86, variando entre R\$4,00 e R\$3,50, ou seja, uma queda de -6,25% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$4,42, variando entre R\$5,00 e R\$3,60, ou seja, uma diminuição de -6,0% em relação a semana anterior. 
