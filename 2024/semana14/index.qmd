...
library(lubridate)
last <- as.Date("2024-03-29")
today <- as.Date("2024-04-05")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,39, variando entre R\$4,00 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,19. Em 2022, o preço deflacionado é de R\$1,32 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,74. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -4,24%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,01, variando entre R\$2,50 e R\$1,50. Este valor é menor do que a média histórica para esta semana (R\$2,49) e do que o preço de 2023 (R\$2,70) mas é maior do que o preço deflacionado de 2022 (R\$1,44). É a primeira vez no ano que a Tommy tem preço menor do que a média da semana. Em relação à semana anterior os preços diminuíram -26,10%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,57, variando entre R\$5,00 e R\$4,20, aumento de 2% em relação a semana anterior. A Tommy para a Europa foi vendida por R\$3,25, variando entre R\$ 3,50 e R\$3,00, queda de -5%.
