...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,45, variando entre R\$3,00 e R\$2,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,71. Em 2022, o preço deflacionado é de R\$1,40 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,09. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -10,26%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,15, variando entre R\$5,00 e R\$3,80. Este valor é maior do que o máximo histórico para esta semana (R\$4,01), que o preço de 2022 (R\$1,08) e o preço deflacionado de 2023 (R\$1,94). Em relação à semana anterior, os preços reduziram -15,13%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,11, variando entre R\$4,50 e R\$3,80, ou seja, uma queda de -1% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$4,70, variando entre R\$5,00 e R\$4,30, ou seja, uma diminuição de -4,0% em relação a semana anterior. 
