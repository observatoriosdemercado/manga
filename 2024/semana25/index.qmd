...
library(lubridate)
last <- as.Date("2024-06-14")
today <- as.Date("2024-06-21")
...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,38, variando entre R\$5,00 e R\$4,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,56. Em 2022, o preço deflacionado é de R\$2,06 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,27. Em relação à semana `r strftime(last, format = "%V")`, os preços caíram -7,01%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,35, variando entre R\$6,00 e R\$5,00. Este valor é maior do que o máximo histórico para esta semana (R\$4,16), que o preço de 2022 (R\$2,32) e o preço deflacionado de 2023 (R\$1,46). Em relação à semana anterior, os preços aumentaram 5,35%. 

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$5,07, variando entre R\$5,50 e R\$4,30, ou seja, uma queda de -5% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$5,88, variando entre R\$6,00 e R\$5,70, ou seja, um aumento de 3% em relação a semana anterior.
