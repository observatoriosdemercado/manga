...
library(lubridate)
last <- as.Date("2024-07-05")
today <- as.Date("2024-07-12")
...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,71, variando entre R\$5,00 e R\$3,10. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,81. Em 2022, o preço deflacionado é de R\$2,10 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,56. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 1,92%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,29, variando entre R\$5,50 e R\$5,00. Este valor é maior do que o máximo histórico para esta semana (R\$4,07), que o preço de 2022 (R\$2,66) e o preço deflacionado de 2023 (R\$2,23). Em relação à semana anterior, os preços caíram -0,19%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,62, variando entre R\$5,00 e R\$4,30, ou seja, uma redução de -7,0% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$5,58, variando entre R\$5,70 e R\$5,50, ou seja, um aumento de 1,0% em relação a semana anterior. 
