...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,90, variando entre R\$1,10 e R\$0,70. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,28. Em 2022, o preço deflacionado é de R\$1,24 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,36. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -28,00%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,62, variando entre R\$0,80 e R\$0,50. Este valor é menor do que a média histórica para esta semana (R\$1,27), que o preço de 2022 (R\$1,07) e que o preço deflacionado de 2023 (R\$1,78). Em relação à semana anterior, os preços reduziram -23,46%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$1,50, sem variação, ou seja, uma queda de -15% em relação a semana anterior. A **Tommy** exportação tanto para os EUA quanto para a Europa foram vendidas na média de R\$1,00, sem variação, redução de -9% em relação ao preço anterior.
