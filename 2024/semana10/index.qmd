...
library(lubridate)
last <- as.Date("2024-03-01")
today <- as.Date("2024-03-08")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,43 variando entre R\$4,00 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,82. Em 2022, o preço deflacionado é de R\$1,28 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,12. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -13,60%. É a terceira semana consecutiva de queda.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,88, variando entre R\$4,30 e R\$3,40. Este valor é maior do que a média histórica para esta semana (R\$2,86), do que o preço de 2022 (R\$1,91) e que o preço deflacionado de 2023 (R\$3,03). Em relação à semana anterior os preços aumentaram 5,15%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,13, variando entre R\$4,80 e R\$3,50, queda de -14% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,38 variando entre R\$4,50 e R\$4,00, aumento de 5% em relação à semana anterior.
