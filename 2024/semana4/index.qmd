...
library(lubridate)
last <- as.Date("2024-01-19")
today <- as.Date("2024-01-26")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,67 variando entre R\$5,30 e R\$3,60. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,16. Em 2022, o preço deflacionado é de R\$1,33 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,03. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram estáveis.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,36, variando entre R\$4,80 e R\$4,00. Este valor é maior do que a média histórica para esta semana (R\$1,79), do que o preço de 2022 (R\$1,41) e que o preço deflacionado de 2023 (R\$0,70). Em relação à semana anterior os preços aumentaram 5,83%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,10, variando entre R\$5,50 e R\$4,80, queda de -1% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,90, respectivamente, variando entre R\$5,20 e R\$4,70, aumento de 9% em relação à semana anterior.
