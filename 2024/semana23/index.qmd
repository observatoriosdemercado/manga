...
library(lubridate)
last <- as.Date("2024-05-31")
today <- as.Date("2024-06-07")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,84, variando entre R\$5,30 e R\$4,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,80. Em 2022, o preço deflacionado é de R\$2,02 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,37. Em relação à semana `r strftime(last, format = "%V")`, os preços caíram -3,01%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,31, variando entre R\$6,00 e R\$4,60. Este valor é maior do que a média histórica para esta semana (R\$2,58), que o preço de 2022 (R\$2,08) e o preço deflacionado de 2023 (R\$1,77). Em relação à semana anterior, os preços aumentaram 7,27%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,44, variando entre R\$6,00 e R\$5,00. Uma queda de -4% em relação a semana anterior. A Tommy para a Europa teve média de R\$5,70, variando entre R\$6,00 e R\$5,40. Uma queda de -2% em relação a semana anterior.
