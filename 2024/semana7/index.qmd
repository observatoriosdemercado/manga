...
library(lubridate)
last <- as.Date("2024-02-09")
today <- as.Date("2024-02-16")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,61 variando entre R\$5,00 e R\$4,10. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,37. Em 2022, o preço deflacionado é de R\$1,37 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,85. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 2,22%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,19, variando entre R\$4,00 e R\$2,70. Este valor é maior do que a média histórica para esta semana (R\$2,49), do que o preço de 2022 (R\$1,79) e que o preço deflacionado de 2023 (R\$2,27). Em relação à semana anterior os preços aumentaram 16,85%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,49, variando entre R\$5,80 e R\$5,20, aumento de 4% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$3,92, variando entre R\$4,50 e R\$3,20, queda de 10% em relação à semana anterior.
