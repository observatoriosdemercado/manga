...
library(lubridate)
last <- as.Date("2024-01-26")
today <- as.Date("2024-02-02")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,22 variando entre R\$4,80 e R\$4,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,19. Em 2022, o preço deflacionado é de R\$1,38 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,37. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -9,64%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,66, variando entre R\$4,50 e R\$3,00. Este valor é maior do que a média histórica para esta semana (R\$1,91), do que o preço de 2022 (R\$1,73) e que o preço deflacionado de 2023 (R\$1,08). Em relação à semana anterior os preços diminuíram -16,06%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,05, variando entre R\$5,20 e R\$5,00, queda de -1% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,32, variando entre R\$4,80 e R\$4,00, queda de -12% em relação à semana anterior.
