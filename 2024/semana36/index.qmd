...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,32, variando entre R\$2,70 e R\$1,90. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,66. Em 2022, o preço deflacionado é de R\$1,46 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,04. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -1,69%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,86, variando entre R\$3,50 e R\$2,30. Este valor é maior do que a média histórica para esta semana (R\$2,08), que o preço de 2022 (R\$1,49) e o preço deflacionado de 2023 (R\$1,99). Em relação à semana anterior, os preços reduziram -19,21%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$3,18, variando entre R\$4,00 e R\$2,90, ou seja, uma queda de -18% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$3,83, variando entre R\$4,50 e R\$3,00, ou seja, uma diminuição de -13,0% em relação a semana anterior. 
