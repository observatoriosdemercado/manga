...
library(lubridate)
last <- as.Date("2024-06-07")
today <- as.Date("2024-06-14")
...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,71, variando entre R\$5,50 e R\$4,40. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,76. Em 2022, o preço deflacionado é de R\$2,19 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,36. Em relação à semana `r strftime(last, format = "%V")`, os preços caíram -2,69%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,09, variando entre R\$6,00 e R\$4,00. Este valor é maior do que o máximo histórico para esta semana (R\$4,84), que o preço de 2022 (R\$2,41) e o preço deflacionado de 2023 (R\$1,69). Em relação à semana anterior, os preços diminuíram -4,14%. 

A **Keitt** foi comercializada por R\$3,93, variando entre R\$4,10 e R\$3,50.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$5,32, variando entre R\$6,00 e R\$5,00. Uma queda de -2% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$5,73, variando entre R\$6,00 e R\$5,00. Um aumento de 1% em relação a semana anterior.
