...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,47, variando entre R\$3,00 e R\$1,90. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,59. Em 2022, o preço deflacionado é de R\$1,30 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,18. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,47%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,59, variando entre R\$2,00 e R\$1,30. Este valor é menor do que a média histórica para esta semana (R\$1,94) e que o preço de 2023 (R\$2,22), mas é maior que o preço deflacionado de 2023 (R\$1,50). Em relação à semana anterior, os preços reduziram -44,41%. A quarta semana seguida de queda de preços.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$2,95, variando entre R\$3,00 e R\$2,80, ou seja, uma queda de -7% em relação a semana anterior. 
