...
library(lubridate)
last <- as.Date("2024-03-22")
today <- as.Date("2024-03-29")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,54, variando entre R\$4,80 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,11. Em 2022, o preço deflacionado é de R\$1,34 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,23. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 10,62%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,72, variando entre R\$3,40 e R\$2,20. Este valor é maior do que a média histórica para esta semana (R\$2,47) e do que o preço de 2022 (R\$1,31) mas é menor do que o preço deflacionado de 2023 (R\$3,12). Em relação à semana anterior os preços diminuíram -15,53%. É a segunda vez no ano que a Tommy tem preço menor do que o encontrado no ano anterior.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,47, variando entre R\$5,20 e R\$4,00, aumento de 12% em relação a semana anterior. A Tommy para a Europa foi vendida por R\$3,42, variando entre R\$ 4,00 e R\$2,80.
