...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,10, variando entre R\$4,50 e R\$2,40. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,77. Em 2022, o preço deflacionado é de R\$1,95 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,11. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 14,39%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,54, variando entre R\$4,00 e R\$3,00. Este valor é maior do que o máximo histórico para esta semana (R\$2,80), que o preço de 2022 (R\$1,90) e o preço deflacionado de 2023 (R\$2,69). Em relação à semana anterior, os preços aumentaram 0,28%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,54, variando entre R\$5,00 e R\$3,80, ou seja, um aumento de 13,0% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$4,25, variando entre R\$5,00 e R\$3,50, ou seja, um aumento de 3,0% em relação a semana anterior. 
