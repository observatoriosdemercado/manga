...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,40, variando entre R\$0,60 e R\$0,30. É a sexta semana seguida de preço abaixo do mínimo histórico. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$1,85. Em 2022, o preço deflacionado é de R\$0,71 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,56. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -24,53%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,76, variando entre R\$1,00 e R\$0,60. Este valor é menor do que a média histórica para esta semana (R\$1,12), que o preço de 2023 (R\$2,15), mas é maior do que o preço deflacionado de 2022 (R\$0,35). Em relação à semana anterior, os preços caíram -13,64%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$0,80, variando entre R\$1,00 e R\$0,70, ou seja, uma queda de -20% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$0,90, variando entre R\$1,00 e R\$0,80, ou seja, uma diminuição de -21% e -25%, respectivamente, em relação a semana anterior. 
...
### GRÁFICO PREÇOS CONSIDERANDO A MÉDIA 2021 A 2023
...
## EVOLUÇÃO DO PREÇO DE MANGA TOMMY AO PRODUTOR DO VALE SÃO FRANCISCO: 2012 A 2024
...
::: panel-tabset
### GRÁFICO PREÇOS CONSIDERANDO A MÉDIA 2012 A 2023
