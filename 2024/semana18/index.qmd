...
library(lubridate)
last <- as.Date("2024-04-26")
today <- as.Date("2024-05-03")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$2,41, variando entre R\$3,20 e R\$2,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,93. Em 2022, o preço deflacionado é de R\$2,06 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,56. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 19,90%. É a primeira semana de alta depois de quatro semanas de queda de preços.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,14, variando entre R\$3,80 e R\$2,50. Este valor é maior do que a média histórica para esta semana (R\$2,46), que o preço de 2022 (R\$2,40) e o preço deflacionado de 2023 (R\$2,53). Em relação à semana anterior, os preços aumentaram 22,18%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,11, variando entre R\$3,70 e R\$2,90, aumento de 3% semana anterior. A Tommy para a Europa teve média de R\$3,65, variando entre R\$4,00 e R\$3,40, aumento de 43% em relação a semana anterior.
