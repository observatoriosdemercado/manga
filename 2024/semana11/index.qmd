...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,16 variando entre R\$3,50 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,88. Em 2022, o preço deflacionado é de R\$1,35 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,08. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -7,87%. É a quarta semana consecutiva de queda.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,96, variando entre R\$4,20 e R\$3,70. Este valor é maior do que a média histórica para esta semana (R\$2,75), do que o preço de 2022 (R\$1,52) e que o preço deflacionado de 2023 (R\$3,56). Em relação à semana anterior os preços aumentaram 2,06%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,72, variando entre R\$4,00 e R\$3,20, queda de -10% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,17 variando entre R\$4,50 e R\$4,00, diminuição de -5% em relação à semana anterior.
