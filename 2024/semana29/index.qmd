...
library(lubridate)
last <- as.Date("2024-07-12")
today <- as.Date("2024-07-19")
...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$3,34, variando entre R\$4,44 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,92. Em 2022, o preço deflacionado é de R\$2,03 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,67. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -9,97%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,77, variando entre R\$5,27 e R\$4,00. Este valor é maior do que o máximo histórico para esta semana (R\$3,70), que o preço de 2022 (R\$2,47) e o preço deflacionado de 2023 (R\$2,28). Em relação à semana anterior, os preços caíram -9,83%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,34, variando entre R\$5,00 e R\$3,50, ou seja, uma redução de -6,0% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$4,92, variando entre R\$5,50 e R\$4,40, ou seja, um queda de -12,0% em relação a semana anterior. 
