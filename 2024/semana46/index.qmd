...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,51, variando entre R\$0,70 e R\$0,40. É a quarta semana seguida de preço abaixo do mínimo histórico. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,10. Em 2022, o preço deflacionado é de R\$1,05 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,89. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram estáveis. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,91, variando entre R\$1,50 e R\$0,60. Este valor é menor do que a média histórica para esta semana (R\$1,24), que o preço de 2023 (R\$1,60), mas é maior do que o preço deflacionado de 2022 (R\$0,56). Em relação à semana anterior, os preços aumentaram 40%, a segunda alta consecutiva.

Sobre os preços de exportação, a **Tommy** tanto para a Europa quanto Estados Unidos teve média de R\$ 1,03, variando entre R\$ 1,20 e R\$ 0,90. A **Kent** teve média de R\$1,10, variando entre R\$1,30 e R\$0,80. 
