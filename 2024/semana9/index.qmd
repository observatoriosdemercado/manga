...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,97 variando entre R\$5,00 e R\$3,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,75. Em 2022, o preço deflacionado é de R\$1,26 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,31. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -7,89%. É a segunda semana consecutiva de queda.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,69, variando entre R\$4,50 e R\$3,20. Este valor é maior do que o máximo histórica para esta semana (R\$3,64), do que o preço de 2022 (R\$2,17) e que o preço deflacionado de 2023 (R\$2,91). Em relação à semana anterior os preços aumentaram 16,77%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,82, variando entre R\$5,50 e R\$4,20, queda de -10% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,15 variando entre R\$5,00 e R\$3,70, aumento de 8    % em relação à semana anterior.
