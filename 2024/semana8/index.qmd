...
library(lubridate)
last <- as.Date("2024-02-16")
today <- as.Date("2024-02-23")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,31 variando entre R\$5,00 e R\$4,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,64. Em 2022, o preço deflacionado é de R\$1,42 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,20. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -6,51%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,16, variando entre R\$3,50 e R\$2,90. Este valor é maior do que a média histórica para esta semana (R\$2,73), do que o preço de 2022 (R\$2,20) e que o preço deflacionado de 2023 (R\$2,54). Em relação à semana anterior os preços diminuíram -0,94%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,37, variando entre R\$5,50 e R\$5,20, queda de -2% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$3,86, variando entre R\$4,00 e R\$3,60, queda de 1% em relação à semana anterior.
