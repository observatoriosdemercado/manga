...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,69, variando entre R\$0,80 e R\$0,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,01. Em 2022, o preço deflacionado é de R\$1,08 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,02. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -23,33%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,48, variando entre R\$0,60 e R\$0,40. Este valor é menor do que a média histórica para esta semana (R\$1,37), que o preço de 2022 (R\$0,79) e que o preço deflacionado de 2023 (R\$1,65). Em relação à semana anterior, os preços reduziram -22,58%.

Sobre os preços de exportação, a **Tommy** exportação tanto para os EUA quanto para a Europa foram vendidas na média de R\$1,38, variando entre R\$1,55 e R\$1,20, aumento de 38% em relação ao preço anterior. A **Kent** foi vendida por uma média de R\$1,70, variando entre R\$2,10 e R\$1,00. Não houve cotação para a **Palmer** exportação.
