...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,51, variando entre R\$0,70 e R\$0,30. É a sétima semana seguida de preço abaixo do mínimo histórico. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$1,96. Em 2022, o preço deflacionado é de R\$0,75 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,23. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 27,50%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,99, variando entre R\$1,30 e R\$0,70. Este valor é menor do que a média histórica para esta semana (R\$1,11), que o preço de 2023 (R\$2,34), mas é maior do que o preço deflacionado de 2022 (R\$0,40). Em relação à semana anterior, os preços subiram 30,26%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$0,96, variando entre R\$1,00 e R\$0,80, ou seja, um aumento de 20% em relação a semana anterior. A **Tommy para a Europa** e a para os **Estados Unidos** tiveram mesma média, de R\$1,10, variando entre R\$1,20 e R\$1,00, ou seja, um aumento de 22%, em relação a semana anterior. 
