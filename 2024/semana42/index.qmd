...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$1,25, variando entre R\$1,70 e R\$1,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,44. Em 2022, o preço deflacionado é de R\$1,25 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 3,47. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -15,54%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,81, variando entre R\$1,00 e R\$0,70. Este valor é menor do que a média histórica para esta semana (R\$1,27), que o preço de 2022 (R\$1,12) e que o preço deflacionado de 2023 (R\$1,93). Em relação à semana anterior, os preços aumentaram 30,65%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$1,76, variando entre R\$2,00 e R\$1,50, ou seja, uma queda de -27% em relação a semana anterior. A **Tommy** exportação tanto para os EUA quanto para a Europa foram vendidas na média de R\$1,10, variando entre R\$1,20 e R\$0,90. A **Kent** foi vendida na média de R\$ 2,50, variando entre R\$3,00 e R\$2,00, redução de -1% em relação ao preço anterior.
