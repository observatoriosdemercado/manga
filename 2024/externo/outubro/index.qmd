...
Em relação aos volumes, em `r strftime(atual, format = "%B")` foram exportadas cerca de 49,7 mil toneladas (t) de mangas pelo Brasil. Este valor é maior do que o máximo histórico (46,1 mil t), superando o que ocorreu no ano de 2023. Os valores representam um aumento de 42,78% em relação à 2022 e de 7,78% em relação à 2023.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B")` foram, aproximadamente, US\$ 61,6 milhões. Em `r strftime(atual, format = "%B")` de 2022, foram gerados cerca de US\$ 28,8 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2023, um total de US\$ 58,3 milhões. O máximo histórico de receita de exportações é US$ 58,3 milhões.

As exportações se concentraram principalmente nas variedades Palmer e Kent para a Europa e Tommy tanto para a Europa quanto Estados Unidos. Em relação aos destinos, no ano, 47,97% das mangas foram enviadas para a Holanda, 17,76% para a Espanha e 12,96% para os Estados Unidos. 

A principal via de envio foi a marítima (87,86%), com 83,08% do total despachado pela alfândega de Fortaleza e 5,61% pelo Aeroporto de Guarulhos-SP.

A maior parte das frutas teve origem em Pernambuco (49,24%) e na Bahia (42,58%). O estado de São Paulo (3,69%) e o Rio Grande do Norte (2,25%) também contribuíram para os resultados obtidos com as exportações de manga.

A taxa de câmbio esperada pelo mercado para o final do ano de 2024 é de R$5,53 para 1 dólar.
