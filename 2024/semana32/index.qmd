...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,80, variando entre R\$5,00 e R\$2,40. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,85. Em 2022, o preço deflacionado é de R\$1,92 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,34. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -9,68%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,56, variando entre R\$5,20 e R\$4,00. Este valor é maior do que o máximo histórico para esta semana (R\$3,22), que o preço de 2022 (R\$1,86) e o preço deflacionado de 2023 (R\$3,22). Em relação à semana anterior, os preços aumentaram 28,81%.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,28, variando entre R\$5,00 e R\$3,80, ou seja, uma queda de -6% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$4,81, variando entre R\$5,00 e R\$4,50, ou seja, um aumento de 13,0% em relação a semana anterior. A **Tommy para os Estados Unidos** teve média de R\$4,80, variando entre R\$5,00 e R\$4,50.  A **Keitt** foi comercializada por R\$4,16, variando entre R\$4,50 e R\$4,00. 
