...
library(lubridate)
last <- as.Date("2024-05-24")
today <- as.Date("2024-05-31")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,99, variando entre R\$6,00 e R\$4,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,86. Em 2022, o preço deflacionado é de R\$1,83 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,33. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,85%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,95, variando entre R\$6,00 e R\$4,50. Este valor é maior do que a média histórica para esta semana (R\$2,65), que o preço de 2022 (R\$1,70) e o preço deflacionado de 2023 (R\$1,35). Em relação à semana anterior, os preços diminuíram -3,70%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,66, variando entre R\$6,00 e R\$4,80. Um aumento de 4% em relação a semana anterior. A Tommy para a Europa teve média de R\$5,82, variando entre R\$6,50 e R\$5,00. Uma queda de -2% em relação a semana anterior.
