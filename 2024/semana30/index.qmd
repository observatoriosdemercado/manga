...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$2,71, variando entre R\$3,30 e R\$2,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,82. Em 2022, o preço deflacionado é de R\$2,13 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,82. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -18,86%. É a sétima queda de preços nas últimas 8 semanas.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,53, variando entre R\$4,00 e R\$3,00. Este valor é maior do que a média histórico para esta semana (R\$2,07), que o preço de 2022 (R\$2,00) e o preço deflacionado de 2023 (R\$2,18). Em relação à semana anterior, os preços caíram -26%. É a quarta queda seguida dos preços.

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$4,03, variando entre R\$4,50 e R\$3,20, ou seja, uma redução de -7,0% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$4,11, variando entre R\$4,50 e R\$3,80, ou seja, um queda de -17,0% em relação a semana anterior. 
