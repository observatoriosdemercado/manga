...
library(lubridate)
last <- as.Date("2024-05-10")
today <- as.Date("2024-05-17")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,32, variando entre R\$5,50 e R\$3,20. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,08. Em 2022, o preço deflacionado é de R\$2,40 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,10. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 34,58%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,13, variando entre R\$6,00 e R\$3,80. Este valor é maior do que a média histórica para esta semana (R\$2,84), que o preço de 2022 (R\$2,35) e o preço deflacionado de 2023 (R\$2,11). Em relação à semana anterior, os preços aumentaram 26,67%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,03, variando entre R\$5,50 e R\$4,80. Um aumento de 32% em relação a semana anterior. A Tommy para a Europa teve média de R\$5,64, variando entre R\$6,00 e R\$5,20. Um aumento de 29% em relação a semana anterior.
