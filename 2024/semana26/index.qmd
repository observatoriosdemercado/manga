...
library(lubridate)
last <- as.Date("2024-06-21")
today <- as.Date("2024-06-28")
...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$4,29, variando entre R\$5,50 e R\$3,70. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,60. Em 2022, o preço deflacionado é de R\$2,15 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,36. Em relação à semana `r strftime(last, format = "%V")`, os preços caíram -2,05%.

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,36, variando entre R\$6,50 e R\$5,00. Este valor é maior do que o máximo histórico para esta semana (R\$4,36), que o preço de 2022 (R\$2,64) e o preço deflacionado de 2023 (R\$1,87). Em relação à semana anterior, os preços aumentaram 0,19%. 

Sobre os preços de exportação, a **Palmer** foi vendida, na média, por R\$5,20, variando entre R\$5,60 e R\$5,00, ou seja, um aumento de 2,5% em relação a semana anterior. A **Tommy para a Europa** teve média de R\$5,86, variando entre R\$6,00 e R\$5,70, ou seja, uma queda de -0,25% em relação a semana anterior.
