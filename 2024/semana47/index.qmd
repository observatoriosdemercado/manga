...
O preço médio de **Palmer** na semana `r strftime(today, format = "%V de %Y")` foi R\$0,53, variando entre R\$0,70 e R\$0,50. É a quinta semana seguida de preço abaixo do mínimo histórico. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,13. Em 2022, o preço deflacionado é de R\$0,96 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,98. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,92%. 

No caso da **Tommy**, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,88, variando entre R\$1,10 e R\$0,70. Este valor é menor do que a média histórica para esta semana (R\$1,16), que o preço de 2023 (R\$1,84), mas é maior do que o preço deflacionado de 2022 (R\$0,36). Em relação à semana anterior, os preços caíram -3,3%.

Sobre os preços de exportação, a **Kent** teve média de R\$0,73, variando entre R\$1,20 e R\$0,50, uma diminuição de -33% em relação a semana anterior. 
