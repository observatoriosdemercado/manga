...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,20, variando entre R\$3,60 e R\$2,80. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,04. Em 2022, o preço deflacionado é de R\$1,37 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,06. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 1,27%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$3,22, variando entre R\$3,80 e R\$2,70. Este valor é maior do que a média histórica para esta semana (R\$2,55) e do que o preço de 2022 (R\$1,11) mas é menor do que o preço deflacionado de 2023 (R\$3,85). Em relação à semana anterior os preços diminuíram -18,69%. É a primeira vez no ano que a Tommy tem preço menor do que o encontrado nos dois anos anteriores.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,98, variando entre R\$4,20 e R\$3,70, aumento de 7% em relação a semana anterior. 
