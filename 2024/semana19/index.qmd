...
library(lubridate)
last <- as.Date("2024-05-03")
today <- as.Date("2024-05-10")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,21, variando entre R\$3,60 e R\$2,60. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,07. Em 2022, o preço deflacionado é de R\$2,03 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,48. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 33,20%. É a segunda semana consecutiva de alta.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$4,05, variando entre R\$4,50 e R\$3,60. Este valor é maior do que a média histórica para esta semana (R\$2,69), que o preço de 2022 (R\$2,16) e o preço deflacionado de 2023 (R\$2,35). Em relação à semana anterior, os preços aumentaram 28,98%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$3,80, variando entre R\$4,00 e R\$3,40, aumento de 22% semana anterior. A Tommy para a Europa teve média de R\$4,38, variando entre R\$4,50 e R\$4,20, aumento de 20% em relação a semana anterior.
