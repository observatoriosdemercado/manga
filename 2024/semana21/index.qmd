...
library(lubridate)
last <- as.Date("2024-05-17")
today <- as.Date("2024-05-24")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,67, variando entre R\$5,80 e R\$3,80. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,01. Em 2022, o preço deflacionado é de R\$2,16 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,50. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,1%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$5,14, variando entre R\$6,00 e R\$4,80. Este valor é maior do que a média histórica para esta semana (R\$2,69), que o preço de 2022 (R\$1,98) e o preço deflacionado de 2023 (R\$1,37). Em relação à semana anterior, os preços aumentaram 0,19%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,44, variando entre R\$6,20 e R\$4,80. Um aumento de 8% em relação a semana anterior. A Tommy para a Europa teve média de R\$5,95, variando entre R\$6,50 e R\$5,50. Um aumento de 5% em relação a semana anterior.
