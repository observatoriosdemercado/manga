...
library(lubridate)
last <- as.Date("2024-04-05")
today <- as.Date("2024-04-12")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$3,21, variando entre R\$3,60 e R\$2,50. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$3,22. Em 2022, o preço deflacionado é de R\$1,37 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 2,94. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -5,31%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$1,51, variando entre R\$1,80 e R\$1,00. Este valor é menor do que a média histórica para esta semana (R\$2,52), do que o preço de 2022 (R\$1,62) e do que o preço deflacionado de 2023 (R\$2,89). É a segunda vez no ano que a Tommy tem preço menor do que a média da semana. Em relação à semana anterior os preços diminuíram -24,88%. 

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$4,00, variando entre R\$4,50 e R\$3,50, redução de -12% em relação a semana anterior. 
