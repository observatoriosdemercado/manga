...
library(lubridate)
last <- as.Date("2024-02-02")
today <- as.Date("2024-02-09")
...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$4,51 variando entre R\$5,50 e R\$4,00. A média histórica dos dados deflacionados, desde 2012 até 2023, para esta semana, é R\$2,23. Em 2022, o preço deflacionado é de R\$1,39 para a semana `r strftime(today, format = "%V")` e, em 2023, o preço é R\$ 1,52. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,87%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$2,73, variando entre R\$3,00 e R\$2,30. Este valor é maior do que a média histórica para esta semana (R\$2,13), do que o preço de 2022 (R\$1,72) e que o preço deflacionado de 2023 (R\$1,76). Em relação à semana anterior os preços diminuíram -25,41%.

Sobre os preços de exportação, a Palmer foi vendida, na média, por R\$5,30, variando entre R\$5,60 e R\$5,00, aumento de 5% em relação a semana anterior. A Tommy para a Europa teve média de preço de R\$4,33, variando entre R\$5,00 e R\$3,50, estável em relação à semana anterior.
